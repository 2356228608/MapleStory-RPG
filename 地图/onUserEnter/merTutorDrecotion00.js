...
ms.npc_ChangeController(1033201, "oid=214353", 266, 2, 1);
ms.npc_ChangeController(1033200, "oid=214354", 138, 2, 1);
...
ms.updateInfoQuest(14756, "d=19/09/20/20/30");
ms.updateInfoQuest(14755, "");
ms.updateInfoQuest(52998, "");
ms.updateInfoQuest(65132, "");
ms.updateInfoQuest(56070, "LUT=19000101");
ms.updateInfoQuest(61585, "0=20190920");
ms.updateInfoQuest(1025, "0=20190920;1=20190919;2=20190918;3=20190917;4=20190916;5=20190915;6=20190912;7=20190909;8=20190906");
ms.updateInfoQuest(26015, "");
ms.updateInfoQuest(26011, "");
ms.updateInfoQuest(32547, "lastDecTime=2019/09/20 20:30:04");
...
ms.playerMessage(-1, "动画播放失败。");
ms.setStandAloneMode(true);
ms.inGameDirectionEvent_MoveAction(4);
ms.inGameDirectionEvent_AskAnswerTime(2000);
} else if (status === i++) {
ms.inGameDirectionEvent_Effect( "Effect/Direction5.img/effect/mercedesInIce/merBalloon/0", 2000, 0, -100, 1, 0, 0, "oid=undefined", undefined, undefined);
ms.inGameDirectionEvent_AskAnswerTime(3000);
} else if (status === i++) {
ms.inGameDirectionEvent_MoveAction(2);
ms.updateInfoQuest(64346, "new=0");
ms.updateInfoQuest(500773, "bonusTalk=1");
ms.updateInfoQuest(500773, "askR=1;bonusTalk=1");
ms.updateInfoQuest(500773, "askR=1;bonusTalk=1;affDown=19/09/20");
ms.updateInfoQuest(500773, "askR=1;bonusTalk=1;s5=0;affDown=19/09/20");
ms.updateInfoQuest(500773, "askR=1;bonusTalk=1;s5=0;resetDate=19/09/20;affDown=19/09/20");
ms.updateInfoQuest(500028, "start=0");
ms.updateInfoQuest(62153, "lastday=19/09/20");
...
ms.updateInfoQuest(18793, "q0=0;q1Date=19/09/20");
ms.updateInfoQuest(18793, "q0=0;q1=0;q1Date=19/09/20");
ms.updateInfoQuest(18793, "q0=0;q1=0;q1Date=19/09/20;q2Date=19/09/20");
ms.updateInfoQuest(18793, "q0=0;q1=0;q2=0;q1Date=19/09/20;q2Date=19/09/20");
ms.updateInfoQuest(18793, "q0=0;q1=0;q2=0;q1Date=19/09/20;pqDate=19/09/20;q2Date=19/09/20");
ms.updateInfoQuest(18793, "q0=0;q1=0;pq=0;q2=0;q1Date=19/09/20;pqDate=19/09/20;q2Date=19/09/20");
ms.forceCompleteQuest(62417);
ms.updateInfoQuest(15458, "lastdate=19/09/20");
ms.updateInfoQuest(15458, "check=0;lastdate=19/09/20");
...
ms.updateInfoQuest(18709, "dailyA=0;dailyB=0;date=19/09/20");
...
ms.updateInfoQuest(15157, "guide=0;gDate=19/09/20");
ms.updateInfoQuest(9, "check1=0;cDate=19/09/20");
...
ms.forceStartQuest(52389, "3");
ms.forceStartQuest(52390, "3");
ms.forceStartQuest(52347, "1");
ms.forceStartQuest(52394, "20");
...
ms.updateInfoQuest(13887, "lastGame=19/09/20;MPAttend=0");
ms.updateInfoQuest(18131, "send=0");
ms.updateInfoQuest(13261, "born=190920");
ms.updateInfoQuest(18079, "index=1");
ms.updateInfoQuest(18079, "index=1;lastR=19/09/20");
ms.updateInfoQuest(18079, "index=1;lastR=19/09/20;sn1=0");
...
ms.updateInfoQuest(18578, "rewardDay=00/01/01;miss=0;fixedDay=19/09/20/00/00");
...
ms.inGameDirectionEvent_Effect( "Effect/Direction5.img/effect/mercedesInIce/merBalloon/1", 2000, 0, -100, 1, 0, 0, "oid=undefined", undefined, undefined);
ms.inGameDirectionEvent_AskAnswerTime(2000);
} else if (status === i++) {
ms.inGameDirectionEvent_MoveAction(2);
ms.curNodeEventEnd(true);
ms.inGameDirectionEvent_Effect( "Effect/Direction5.img/effect/mercedesInIce/merBalloon/2", 2000, 0, -100, 1, 0, 0, "oid=undefined", undefined, undefined);
ms.inGameDirectionEvent_AskAnswerTime(2000);
} else if (status === i++) {
ms.inGameDirectionEvent_MoveAction(2);
ms.curNodeEventEnd(true);
ms.inGameDirectionEvent_Effect( "Effect/Direction5.img/effect/mercedesInIce/merBalloon/3", 2000, 0, -100, 1, 0, 0, "oid=undefined", undefined, undefined);
ms.inGameDirectionEvent_AskAnswerTime(2000);
} else if (status === i++) {
ms.inGameDirectionEvent_MoveAction(2);
ms.curNodeEventEnd(true);
...
ms.updateInfoQuest(62483, "eNum=0;lastDate=19/09/20");
...
ms.updateInfoQuest(62497, "lastDate=19/09/20");
ms.updateInfoQuest(62499, "lastDate=19/09/20");
ms.updateInfoQuest(63033, "dayNW=0");
ms.updateInfoQuest(63120, "dayNR=0");
ms.updateInfoQuest(63042, "dayNR=0");
ms.updateInfoQuest(62457, "date=19/09/20");
ms.updateInfoQuest(62457, "sing=0;date=19/09/20");
ms.forceStartQuest(62458, "");
ms.updateInfoQuest(62459, "date=19/09/20");
ms.updateInfoQuest(62459, "date=19/09/20;sing1=0");
ms.forceStartQuest(62460, "");
ms.updateInfoQuest(62461, "date=19/09/20");
ms.updateInfoQuest(62461, "han=0;date=19/09/20");
ms.forceStartQuest(62462, "");
ms.updateInfoQuest(62463, "date=19/09/20");
ms.updateInfoQuest(62463, "date=19/09/20;han1=0");
ms.forceStartQuest(62464, "");
ms.updateInfoQuest(58977, "");
ms.updateInfoQuest(58977, "lastDay=19/09/20/20/30");
...
ms.updateInfoQuest(18192, "val2=0;tDate=19/09/20/20/30;val=0");
ms.updateInfoQuest(18192, "count=0;val2=0;tDate=19/09/20/20/30;val=0");
ms.updateInfoQuest(500208, "val=0");
ms.updateInfoQuest(500208, "val2=0;val=0");
ms.updateInfoQuest(500208, "val2=0;tDate=19/09/20/20/30;val=0");
ms.updateInfoQuest(500208, "count=0;val2=0;tDate=19/09/20/20/30;val=0");
ms.updateInfoQuest(500209, "val=0");
ms.updateInfoQuest(500209, "val2=0;val=0");
ms.updateInfoQuest(500209, "val2=0;tDate=19/09/20/20/30;val=0");
ms.updateInfoQuest(500209, "count=0;val2=0;tDate=19/09/20/20/30;val=0");
ms.updateInfoQuest(18282, "count=0");
ms.updateInfoQuest(18282, "count=0;last=19/09/20");
...
ms.inGameDirectionEvent_Effect( "Effect/Direction5.img/effect/mercedesInIce/merBalloon/4", 2000, 0, -100, 1, 0, 0, "oid=undefined", undefined, undefined);
ms.inGameDirectionEvent_AskAnswerTime(2000);
} else if (status === i++) {
ms.inGameDirectionEvent_MoveAction(2);
ms.curNodeEventEnd(true);
ms.inGameDirectionEvent_Effect( "Effect/Direction5.img/effect/mercedesInIce/merBalloon/5", 2000, 0, -100, 1, 0, 0, "oid=undefined", undefined, undefined);
ms.inGameDirectionEvent_AskAnswerTime(2000);
} else if (status === i++) {
ms.setInGameDirectionMode(false, true, false);
ms.getTopMsgFont("按下键盘的方向键 [←]、[→]键就能移动。", 3, 20, 20, 0);
ms.dispose();
	}
}
