...
//    } else if (status === i++) {
        ms.inGameDirectionEvent_Effect("Effect/Direction6.img/effect/tuto/balloonMsg1/9", 2000, 0, -100);
        ...
        ms.inGameDirectionEvent_Effect("Effect/Direction6.img/effect/tuto/balloonMsg1/4", 500, 0, -100, 1, 0, 1, 2159309, 0, 0);
        ...
        ms.npc_SetSpecialAction(2159309, "summon");
        ms.inGameDirectionEvent_Effect("Effect/Direction6.img/effect/tuto/balloonMsg1/4", 1000, 0, -100, 1, 0, 1, 2159309, 0, 0);
        ...
        ms.inGameDirectionEvent_Effect("Effect/Direction6.img/effect/tuto/balloonMsg1/10", 2000, 0, -100, 1, 0, 1, 2159309, 0, 0);
        ms.inGameDirectionEvent_AskAnswerTime(1500);
    } else if (status === i++) {
        ms.inGameDirectionEvent_Effect("Effect/Direction6.img/effect/tuto/balloonMsg1/11", 2000, 0, -100);
        ms.inGameDirectionEvent_AskAnswerTime(1500);
    } else if (status === i++) {
        ...
        ms.inGameDirectionEvent_Effect("Effect/Direction6.img/effect/tuto/balloonMsg0/0", 2000, 0, -100, 1, 0, 1, 2159309, 0, 0);
        ...
        ms.npc_LeaveField(2159309);
        ms.inGameDirectionEvent_Effect("Effect/Direction6.img/effect/tuto/balloonMsg2/2", 2000, 0, -100, 0, 0);
