...
function action(mode, type, selection) {
    ...
    if (status <= i++) {
		...
		ms.fieldEffect_PlayBGM("Bgm47/AsylumPiano");
		...
		//ms.fieldEffect_ProcessOnOffLayer("prologue", 0);//mode 1A
		ms.fieldEffect_ProcessOnOffLayer("BlackOut", "", 2, 100, 0, 0, 0, 0, 0);//mode 12
		ms.inGameDirectionEvent_AskAnswerTime(500);
    }else if (status === i++) {//
		ms.fieldEffect_OverlapScreenDetail(0, 1000, 3000, 1);//mode 14
		ms.inGameDirectionEvent_PushScaleInfo(0, 1000, 2147483647, 2147483647, 2147483647);//mode 7
		//ms.inGameDirectionEvent_PushMoveInfo(1, 0, 0, 0, 0);//mode 5
