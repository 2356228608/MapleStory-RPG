...
function setup(level, leaderid) {
    ...
    em.setProperty("leader", "true");
    var eim = em.newInstance("NewEvent14");
    eim.setInstanceMap(324020000).resetPQ(level);
    eim.setInstanceMap(324021000).resetPQ(level);
    eim.setInstanceMap(324022000).resetPQ(level);
    eim.setInstanceMap(324023000).resetPQ(level);
    eim.setInstanceMap(324024000).resetPQ(level);
    eim.setInstanceMap(324025000).resetPQ(level);
    eim.setInstanceMap(324026000).resetPQ(level);
...
function changedMap(eim, player, mapid) {
    if (mapid < 324020000 || mapid > 324026000) {
