...
function setup(level, leaderid) {
    ...
    em.setProperty("leader", "true");
    var eim = em.newInstance("NewEvent5");
    eim.setInstanceMap(322010000).resetPQ(level);
    eim.setInstanceMap(322011000).resetPQ(level);
    eim.setInstanceMap(322012000).resetPQ(level);
    eim.setInstanceMap(322013000).resetPQ(level);
    eim.setInstanceMap(322014000).resetPQ(level);
    eim.setInstanceMap(322015000).resetPQ(level);
    eim.setInstanceMap(322016000).resetPQ(level);
...
function changedMap(eim, player, mapid) {
    if (mapid < 322010000 || mapid > 322016000) {
