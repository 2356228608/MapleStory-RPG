...
function setup(level, leaderid) {
    ...
    em.setProperty("leader", "true");
    var eim = em.newInstance("NewEvent32");
    eim.setInstanceMap(328030000).resetPQ(level);
    eim.setInstanceMap(328031000).resetPQ(level);
    eim.setInstanceMap(328032000).resetPQ(level);
    eim.setInstanceMap(328033000).resetPQ(level);
    eim.setInstanceMap(328034000).resetPQ(level);
    eim.setInstanceMap(328035000).resetPQ(level);
    eim.setInstanceMap(328036000).resetPQ(level);
...
function changedMap(eim, player, mapid) {
    if (mapid < 328030000 || mapid > 328036000) {
