...
function setup(level, leaderid) {
    ...
    em.setProperty("leader", "true");
    var eim = em.newInstance("NewEvent10");
    eim.setInstanceMap(323020000).resetPQ(level);
    eim.setInstanceMap(323021000).resetPQ(level);
    eim.setInstanceMap(323022000).resetPQ(level);
    eim.setInstanceMap(323023000).resetPQ(level);
    eim.setInstanceMap(323024000).resetPQ(level);
    eim.setInstanceMap(323025000).resetPQ(level);
    eim.setInstanceMap(323026000).resetPQ(level);
...
function changedMap(eim, player, mapid) {
    if (mapid < 323020000 || mapid > 323026000) {
