...
function changedMap(eim, player, mapid) {
    switch (mapid) {
        ...
        case 350050300: //电梯，之后出现怪物，消灭掉它们直接进入下一关
            ...
            map.spawnNpc(1540446, new java.awt.Point(-36, 5));
            break;
        ...
        case 350051100: //电梯到达 代码 D1 Z05 001
            ...
            map.startMapEffect("机械门坏了！！", 5120124);
            eim.restartEventTimer(1000 * 60 * 45);//第四大关有45分钟的时间
            break;
...
function monsterValue(eim, mobid) {
    ...
    if (mobid == 8240099) {//斯乌死后，召唤NPC
        ...
        var map = eim.setInstanceMap(350060160);
        //map.resetFully();
        map.startMapEffect("斯乌已击败,请到上面的传送洞领取奖励吧！！", 5120124);
        return 0;
    }
