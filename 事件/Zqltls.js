...
function setup(eim, leaderid) {
    ...
    em.setProperty("leader", "true");
    var eim = em.newInstance("Zqltls");
    var map = eim.setInstanceMap(931050401);
    map.resetFully();
    eim.getMapFactory().getMap(931050401).killAllMonsters(false);
    ...
    map.spawnMonsterOnGroundBelow(mob, new java.awt.Point(-65, 64));
