...
function setup(level, leaderid) {
    ...
    em.setProperty("leader", "true");
    var eim = em.newInstance("NewEvent17");
    eim.setInstanceMap(324050000).resetPQ(level);
    eim.setInstanceMap(324051000).resetPQ(level);
    eim.setInstanceMap(324052000).resetPQ(level);
    eim.setInstanceMap(324053000).resetPQ(level);
    eim.setInstanceMap(324054000).resetPQ(level);
    eim.setInstanceMap(324055000).resetPQ(level);
    eim.setInstanceMap(324056000).resetPQ(level);
...
function changedMap(eim, player, mapid) {
    if (mapid < 324050000 || mapid > 324056000) {
