...
var setupTask;
var probability = 500.0;//概率即1000/10000=0.1
...
function fishing(c) {
    if (getItemAmount(c, 5220002) && getItemAmount(c, 3011000) && getItemAmount(c, 5340001)) {
        var cc = c.getClient();
        ...
        c.dropMessage(5, "【高级钓鱼场】高级双倍极速钓鱼场必须要有高级鱼饵、双倍爆率钓鱼卡、极速钓鱼竿、钓鱼专用椅才能钓鱼.");
    }
    return true;
}
    ...
    if (fish.length > 0) {
        if (randNum < pp) {//钓到鱼了
            ...
            if (fish[randfish] == 2431690)
            {
                ...
                em.broadcastYellowMsg("[" + xs + "]【钓鱼系统】" + " : " + "玩家 " + c.getName() + " 在极速钓鱼场钓到了 1 条金龙鱼，绝版道具换不停，赶紧加入吧~");
            } else {
                var fn = "鱼";
                var i = 0;
                ...
                {
                    em.broadcastServerMsg("[" + xs + "]【钓鱼系统】" + " : " + "玩家 " + c.getName() + " 在极速鱼场钓到[" + fn + "]，更多精品等您钓获，速度围观！");
