...
function setup(level, leaderid) {
    ...
    em.setProperty("leader", "true");
    var eim = em.newInstance("NewEvent26");
    eim.setInstanceMap(327010000).resetPQ(level);
    eim.setInstanceMap(327011000).resetPQ(level);
    eim.setInstanceMap(327012000).resetPQ(level);
    eim.setInstanceMap(327013000).resetPQ(level);
    eim.setInstanceMap(327014000).resetPQ(level);
    eim.setInstanceMap(327015000).resetPQ(level);
    eim.setInstanceMap(327016000).resetPQ(level);
...
function changedMap(eim, player, mapid) {
    if (mapid < 327010000 || mapid > 327016000) {
