...
function monsterValue(eim, mobId) {
    switch (mobId) {
        case 9400080:
            ...
            break;
		case 8880301:
			var map = eim.getMapInstance(450008400);
			map.spawnNpc(3003533, new java.awt.Point(-656, 159));
			map.startMapEffect("威尔已击败,请和左侧的NPC对话领取奖励吧.", 5120161);
			eim.broadcastPlayerMsg(6, "威尔已击败,请和左侧的NPC对话领取奖励吧.。");
