...
function setup(eim, leaderid) {
    ...
    var map = eim.setInstanceMap(706041700);//867114230
    map.resetFully();
    eim.getMapFactory().getMap(706041700).killAllMonsters(false);
    var mob = em.getMonster(9402110);
    eim.registerMonster(mob);
    map.spawnMonsterOnGroundBelow(mob, new java.awt.Point(149, 488));
...
function playerRevive(eim, player) {
    ...
    player.addHP(50);
    var map = eim.getMapFactoryMap(706041700);
    player.changeMap(map, map.getPortal(0));
    return true;
}
/*
