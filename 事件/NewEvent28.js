...
function setup(level, leaderid) {
    ...
    em.setProperty("leader", "true");
    var eim = em.newInstance("NewEvent29");
    eim.setInstanceMap(327030000).resetPQ(level);
    eim.setInstanceMap(327031000).resetPQ(level);
    eim.setInstanceMap(327032000).resetPQ(level);
    eim.setInstanceMap(327033000).resetPQ(level);
    eim.setInstanceMap(327034000).resetPQ(level);
    eim.setInstanceMap(327035000).resetPQ(level);
    eim.setInstanceMap(327036000).resetPQ(level);
...
function changedMap(eim, player, mapid) {
    if (mapid < 327030000 || mapid > 327036000) {
