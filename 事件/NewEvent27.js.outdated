...
function setup(level, leaderid) {
    ...
    em.setProperty("leader", "true");
    var eim = em.newInstance("NewEvent27");
    eim.setInstanceMap(327020000).resetPQ(level);
    eim.setInstanceMap(327021000).resetPQ(level);
    eim.setInstanceMap(327022000).resetPQ(level);
    eim.setInstanceMap(327023000).resetPQ(level);
    eim.setInstanceMap(327024000).resetPQ(level);
    eim.setInstanceMap(327025000).resetPQ(level);
    eim.setInstanceMap(327026000).resetPQ(level);
...
function changedMap(eim, player, mapid) {
    if (mapid < 327020000 || mapid > 327026000) {
