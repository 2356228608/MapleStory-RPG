...
function setup(level, leaderid) {
    ...
    em.setProperty("leader", "true");
    var eim = em.newInstance("NewEvent11");
    eim.setInstanceMap(323030000).resetPQ(level);
    eim.setInstanceMap(323031000).resetPQ(level);
    eim.setInstanceMap(323032000).resetPQ(level);
    eim.setInstanceMap(323033000).resetPQ(level);
    eim.setInstanceMap(323034000).resetPQ(level);
    eim.setInstanceMap(323035000).resetPQ(level);
    eim.setInstanceMap(323036000).resetPQ(level);
...
function changedMap(eim, player, mapid) {
    if (mapid < 323030000 || mapid > 323036000) {
