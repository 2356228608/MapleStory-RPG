...
function setup(level, leaderid) {
    ...
    em.setProperty("leader", "true");
    var eim = em.newInstance("NewEvent30");
    eim.setInstanceMap(328010000).resetPQ(level);
    eim.setInstanceMap(328011000).resetPQ(level);
    eim.setInstanceMap(328012000).resetPQ(level);
    eim.setInstanceMap(328013000).resetPQ(level);
    eim.setInstanceMap(328014000).resetPQ(level);
    eim.setInstanceMap(328015000).resetPQ(level);
    eim.setInstanceMap(328016000).resetPQ(level);
...
function changedMap(eim, player, mapid) {
    if (mapid < 328010000 || mapid > 328016000) {
