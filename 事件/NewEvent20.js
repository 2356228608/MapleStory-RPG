...
function setup(level, leaderid) {
    ...
    em.setProperty("leader", "true");
    var eim = em.newInstance("NewEvent20");
    eim.setInstanceMap(325030000).resetPQ(level);
    eim.setInstanceMap(325031000).resetPQ(level);
    eim.setInstanceMap(325032000).resetPQ(level);
    eim.setInstanceMap(325033000).resetPQ(level);
    eim.setInstanceMap(325034000).resetPQ(level);
    eim.setInstanceMap(325035000).resetPQ(level);
    eim.setInstanceMap(325036000).resetPQ(level);
...
function changedMap(eim, player, mapid) {
    if (mapid < 325030000 || mapid > 325036000) {
