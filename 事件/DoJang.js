...
var mobs = new Array(			// 层数、怪物ID、数量、加强倍数
										// 第一层		极速蜗牛
										new Array(1, 1, 100100, 20, 30000),		//Lv1 - 蜗牛 15
										new Array(1, 1, 100101, 20, 30000),		//Lv2 - 蓝蜗牛 20
										new Array(1, 1, 130101, 20, 24000),			//Lv5 - 红蜗牛 50
										new Array(1, 1, 4250000, 20, 30),			//Lv98 - 苔藓蜗牛 61000
										new Array(1, 1, 9400908, 10, 30),			//Lv105 - 邪恶苔藓蜗牛 75000
										new Array(1, 1, 9400827, 10, 30),			//Lv71 - 黑暗苔藓蜗牛 10000

										// 第二层		圆一次马里奥的梦
										new Array(2, 1, 2600200, 20, 3),			//Lv122 - 绿蘑菇 447770
										new Array(2, 1, 2600201, 20, 3),			//Lv122 - 受挫的绿蘑菇 447770
										new Array(2, 1, 2600202, 20, 3),			//Lv122 - 花蘑菇 447770
										new Array(2, 1, 2600203, 20, 3),			//Lv122 - 刺蘑菇 447770
										...
										new Array(4, 1, 2600205, 20, 3),			//Lv122 - 哭泣的蓝蘑菇 447770
										new Array(4, 1, 5250000, 20, 15),			//Lv102 - 苔藓蘑菇 69000
										...
										new Array(5, 1, 9100008, 2, 3),				//超级可乐蜗牛 可忽略通关 930000
...
var dropItemsAdvanced = 2340000;	// 秘密箱子-Lv140套装箱

var status = 0;
var text = "";
var baseMapId = 925070000;
var party = new Array();
var mobCount = 0;
...
function changedMap(eim, player, mapid) {
	if (mapid < 925070100 || mapid > 925070000) {	// 不在武陵副本地图内
		eim.dispose();
		return;
	}
