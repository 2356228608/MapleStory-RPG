...
function setup(level, leaderid) {
    ...
    em.setProperty("leader", "true");
    var eim = em.newInstance("NewEvent25");
    eim.setInstanceMap(326040000).resetPQ(level);
    eim.setInstanceMap(326041000).resetPQ(level);
    eim.setInstanceMap(326042000).resetPQ(level);
    eim.setInstanceMap(326043000).resetPQ(level);
    eim.setInstanceMap(326044000).resetPQ(level);
    eim.setInstanceMap(326045000).resetPQ(level);
    eim.setInstanceMap(326046000).resetPQ(level);
...
function changedMap(eim, player, mapid) {
    if (mapid < 326040000 || mapid > 326046000) {
