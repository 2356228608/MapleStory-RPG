...
function setup(mapid) {
    ...
    var eim = em.newInstance("NewEvent33" + mapid);
    eim.setInstanceMap(749050501); // <exit>
...
//eim.restartEventTimer(180000);
    eim.schedule("end", 1 * 60 * 1000); // 3 minutes
    eim.startEventClock(59 * 1000);
//} else {
//    eim.setProperty("blue", carnivalParty.getLeader().getId() + "");
    eim.schedule("start", 10 * 1000);
    eim.startEventClock(10 * 1000);
    //eim.restartEventTime(10 * 1000);
//}
}
