...
function setup(level, leaderid) {
    ...
    em.setProperty("leader", "true");
    var eim = em.newInstance("NewEvent12");
    eim.setInstanceMap(323040000).resetPQ(level);
    eim.setInstanceMap(323041000).resetPQ(level);
    eim.setInstanceMap(323042000).resetPQ(level);
    eim.setInstanceMap(323043000).resetPQ(level);
    eim.setInstanceMap(323044000).resetPQ(level);
    eim.setInstanceMap(323045000).resetPQ(level);
    eim.setInstanceMap(323046000).resetPQ(level);
...
function changedMap(eim, player, mapid) {
    if (mapid < 323040000 || mapid > 323046000) {
