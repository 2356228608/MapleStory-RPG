...
function setup(level, leaderid) {
    ...
    em.setProperty("leader", "true");
    var eim = em.newInstance("NewEvent2");
    eim.setInstanceMap(321130000).resetPQ(level);
    eim.setInstanceMap(321131000).resetPQ(level);
    eim.setInstanceMap(321132000).resetPQ(level);
    eim.setInstanceMap(321133000).resetPQ(level);
    eim.setInstanceMap(321134000).resetPQ(level);
    eim.setInstanceMap(321135000).resetPQ(level);
    eim.setInstanceMap(321136000).resetPQ(level);
...
function changedMap(eim, player, mapid) {
    if (mapid < 321130000 || mapid > 321136000) {
