...
function setup(level, leaderid) {
    ...
    em.setProperty("leader", "true");
    var eim = em.newInstance("NewEvent6");
    eim.setInstanceMap(322020000).resetPQ(level);
    eim.setInstanceMap(322021000).resetPQ(level);
    eim.setInstanceMap(322022000).resetPQ(level);
    eim.setInstanceMap(322023000).resetPQ(level);
    eim.setInstanceMap(322024000).resetPQ(level);
    eim.setInstanceMap(322025000).resetPQ(level);
    eim.setInstanceMap(322026000).resetPQ(level);
...
function changedMap(eim, player, mapid) {
    if (mapid < 322020000 || mapid > 322026000) {
