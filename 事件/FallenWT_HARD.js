...
function setup(eim, leaderid) {
    ...
    //modified.setOMp(mob.getMobMaxMp()*8000);
    //mob.setOverrideStats(modified);
    eim.registerMonster(mob);
    map.spawnMonsterOnGroundBelow(mob, new java.awt.Point(808, 16));
    ...
    /*for (var i = 0; i < 3; i++) {
     ...
     map.spawnMonsterOnGroundBelow(mob1, new java.awt.Point(808, 16));
     }*/
