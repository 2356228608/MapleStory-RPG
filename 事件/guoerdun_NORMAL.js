 ...
 *  脚本功能：敦凯尔-普通
 *  地图ID: //'黎曼 : 临尽之地'993071600
 *  @Author 娜娜 
 */

var Mapid;
var modified;
var bossmapid=993071600;
var addMonsterTask;
...
function setup(level, leaderid) {
    ...
    em.setProperty("leader", "true");
    var eim = em.newInstance("guoerdun_NORMAL");
...
function playerEntry(eim, player) {
    ...
    player.dropMessage(6, "[敦凯尔-普通] 已开始挑战。");
}
...
function changedMap(eim, player, mapid) {
	...
	if(mapid == bossmapid){
		...
		eim.worldSpouseMessage(0x24, "[敦凯尔-普通] 已退出挑战,副本空闲,强者可以去挑战。");
