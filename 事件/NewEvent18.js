...
function setup(level, leaderid) {
    ...
    em.setProperty("leader", "true");
    var eim = em.newInstance("NewEvent18");
    eim.setInstanceMap(325010000).resetPQ(level);
    eim.setInstanceMap(325011000).resetPQ(level);
    eim.setInstanceMap(325012000).resetPQ(level);
    eim.setInstanceMap(325013000).resetPQ(level);
    eim.setInstanceMap(325014000).resetPQ(level);
    eim.setInstanceMap(325015000).resetPQ(level);
    eim.setInstanceMap(325016000).resetPQ(level);
...
function changedMap(eim, player, mapid) {
    if (mapid < 325010000 || mapid > 325016000) {
