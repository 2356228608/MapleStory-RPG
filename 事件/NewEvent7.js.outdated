...
function setup(level, leaderid) {
    ...
    em.setProperty("leader", "true");
    var eim = em.newInstance("NewEvent7");
    eim.setInstanceMap(322030000).resetPQ(level);
    eim.setInstanceMap(322031000).resetPQ(level);
    eim.setInstanceMap(322032000).resetPQ(level);
    eim.setInstanceMap(322033000).resetPQ(level);
    eim.setInstanceMap(322034000).resetPQ(level);
    eim.setInstanceMap(322035000).resetPQ(level);
    eim.setInstanceMap(322036000).resetPQ(level);
...
function changedMap(eim, player, mapid) {
    if (mapid < 322030000 || mapid > 322036000) {
