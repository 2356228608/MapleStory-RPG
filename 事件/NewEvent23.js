...
function setup(level, leaderid) {
    ...
    em.setProperty("leader", "true");
    var eim = em.newInstance("NewEvent23");
    eim.setInstanceMap(326020000).resetPQ(level);
    eim.setInstanceMap(326021000).resetPQ(level);
    eim.setInstanceMap(326022000).resetPQ(level);
    eim.setInstanceMap(326023000).resetPQ(level);
    eim.setInstanceMap(326024000).resetPQ(level);
    eim.setInstanceMap(326025000).resetPQ(level);
    eim.setInstanceMap(326026000).resetPQ(level);
...
function changedMap(eim, player, mapid) {
    if (mapid < 326020000 || mapid > 326026000) {
