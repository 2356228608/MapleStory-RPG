...
function setup() {
    ...
    var createInstances = new Array("lolcastle1", "lolcastle2", "lolcastle3", "lolcastle4", "lolcastle5");
    var x;
...
function allMonstersDead(eim) {
    ...
    if (priceRand <= 35) {
        ...
        if (eim.getName().equals("lolcastle1") || eim.getName().equals("lolcastle2")) {
            ...
            uberWeapons = new Array(1452008, 1472021, 1462007, 1332054, 1312008, 1322021, 1302010, 1442046, 1432004, 1382011, 1412003, 1422005, 1402013, 1372011);
        } else {
            // lv100 weapons
            uberWeapons = new Array(1452019, 1472053, 1462015, 1332051, 1312030, 1322045, 1302056, 1442044, 1432030, 1382035, 1412021, 1422027, 1402037, 1372010, 1302026, // black umbrella
        ...
        // powerups
        var powerUps = new Array(new Array(2022273, 3), new Array(2022245, 3), new Array(2022179, 1));
