...
function setup(level, leaderid) {
    ...
    em.setProperty("leader", "true");
    var eim = em.newInstance("NewEvent19");
    eim.setInstanceMap(325020000).resetPQ(level);
    eim.setInstanceMap(325021000).resetPQ(level);
    eim.setInstanceMap(325022000).resetPQ(level);
    eim.setInstanceMap(325023000).resetPQ(level);
    eim.setInstanceMap(325024000).resetPQ(level);
    eim.setInstanceMap(325025000).resetPQ(level);
    eim.setInstanceMap(325026000).resetPQ(level);
...
function changedMap(eim, player, mapid) {
    if (mapid < 325020000 || mapid > 325026000) {
