...
function setup(level, leaderid) {
    ...
    em.setProperty("leader", "true");
    var eim = em.newInstance("NewEvent22");
    eim.setInstanceMap(326010000).resetPQ(level);
    eim.setInstanceMap(326011000).resetPQ(level);
    eim.setInstanceMap(326012000).resetPQ(level);
    eim.setInstanceMap(326013000).resetPQ(level);
    eim.setInstanceMap(326014000).resetPQ(level);
    eim.setInstanceMap(326015000).resetPQ(level);
    eim.setInstanceMap(326016000).resetPQ(level);
...
function changedMap(eim, player, mapid) {
    if (mapid < 326010000 || mapid > 326016000) {
