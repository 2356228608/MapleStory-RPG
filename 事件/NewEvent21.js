...
function setup(level, leaderid) {
    ...
    em.setProperty("leader", "true");
    var eim = em.newInstance("NewEvent21");
    eim.setInstanceMap(325040000).resetPQ(level);
    eim.setInstanceMap(325041000).resetPQ(level);
    eim.setInstanceMap(325042000).resetPQ(level);
    eim.setInstanceMap(325043000).resetPQ(level);
    eim.setInstanceMap(325044000).resetPQ(level);
    eim.setInstanceMap(325045000).resetPQ(level);
    eim.setInstanceMap(325046000).resetPQ(level);
...
function changedMap(eim, player, mapid) {
    if (mapid < 325040000 || mapid > 325046000) {
