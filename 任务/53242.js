...
function start(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            qm.sendNextSNoESC("Binh tinh nao #p2111007#, anh dang lam gi the?.");
        } else if (status == 2) {
            qm.sendNext("Khong co gi lon lam dau. Nhung thuc su quanh day chang co ai ca. Cau se giup toi chu?.");
        } else if (status == 3) {
            qm.sendNextSNoESC("Doi toi uong chut cafe va toi se suy nghi ve dieu nay...");
        } else if (status == 4) {
            qm.askAcceptDecline("Neu cau giup toi. Toi se ke cho cau moi chuyen toi biet. Cau se giup toi chu?");
        } else if (status == 5) {
            ...
            qm.sendNextSNoESC("Va anh khong muon ai biet ve dieu do?");
        } else if (status == 8) {
            qm.sendNext("Toi muon giu bi mat cho khach hang cua minh. Ho muon toi lam #z4033250##i4033250#. Va ho tra tien rat hau hinh =p~");
        } else if (status == 9) {
            qm.sendNextSNoESC("(#z4033250##i4033250#, nghe cai ten mon do nay lam minh cam thay co gi do nguy hiem...)");
        } else if (status == 10) {
            qm.sendNextSNoESC("Anh biet khach hang la ai khong?");
        } else if (status == 11) {
            ...
            qm.sendNextSNoESC("(Vi khach nay co dieu gi do dac biet. minh se hoi anh ta sau khi hoan thanh moi duoc!)");
        } else if (status == 13) {
            qm.forceStartQuest();
            qm.dispose();
        }
