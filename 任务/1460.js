    ...
    if (mode == -1) {
        ...
        switch (status) {
            case 0:
                ...
                break;
            case 1:
                qm.askYesNo("说不定你不仅能活用你的力量，还能趁此机会变得更强。\r\n如果你有意向，请来时间神殿找我吧。\r\n\r\n#b(如果接受的话，将移动到时间神殿进行#e5次转职#n。)#k");
                break;
            case 2:
        ...
        if (cs == null || cs.equals("0") || cs.equals("")) {
            switch (status) {
                ...
                case 6:
                    ...
                    //qm.warp(450000200);
                    //**********一键5转
                    qm.forceCompleteQuest(1460);
                    qm.forceCompleteQuest(1461);
                    qm.forceCompleteQuest(1462);
                    qm.forceCompleteQuest(1463);
                    qm.forceCompleteQuest(1464);
                    qm.forceCompleteQuest(1465);
                    qm.forceCompleteQuest(1466);
                    qm.askYesNo("逗你玩的，你已经获得了新力量，完成了5转。请打开技能面板查看。");
                    qm.dispose();
                    //**********
                    break;
                default:
