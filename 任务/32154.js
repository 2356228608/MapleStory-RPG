...
function start(mode, type, selection) {
    if (mode == 1)
        ...
        status--;
    if (status == 0) {
        qm.askAcceptDecline("You seem to be in good condition. How about another mission? I've received an urgent request from the #bEllinel Fairy Academy");
    } else if (status == 1) {
        ...
        qm.askYesNo("Fanzy will take you into the land of the fairies. I can send you to him directly, if you'd like.'");
    } else if (status == 4) {
        qm.warp(101030000, 0);
        qm.forceStartQuest();
        qm.dispose();
