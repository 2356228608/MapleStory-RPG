...
function start(mode, type, selection) {
    ...
    if (status <= i++) {
        ...
        qm.sendNextPrev_Illus("春秋，难道你知道当时究竟发生了什么事？", 9130009);
    } else if (status === i++) {
        qm.sendNextPrev_Illus("毕竟我对这方面的问题多少有些了解嘛。该从哪里开始说起呢……对了，我就先和你们讲讲，信长要进行的魔王降临仪式究竟是怎么一回事吧。");
    } else if (status === i++) {
        ...
        qm.sendNextPrev_Illus("知道他的这个打算后，我立刻派出神那和其他弟子，前去阻止信长进行仪式。这一点在场的各位应该都非常清楚。在这些弟子的努力下，仪式并没有依照信长的想法顺利进行。");
    } else if (status === i++) {
        qm.sendNextPrev_Illus("不过同时，也发生了一件超乎我想象的事情。次元之门的方向出现了扭曲。本来应该由第六天魔界向日本开启的次元之门，竟然将日本到“这边”这个世界连接了起来。如此一来，当时身处本能寺的织田军和我们这些人，就全都被转移到了“这边”这个世界。次元空间对大家自身的“强弱”产生影响，导致我们每个人都出现了不同的时间与地点。");
    } else if (status === i++) {
        qm.sendNextPrev_Illus("啊哈哈，没想到还能发生连厉害的大阴阳师土御门春秋都料想不到的事情啊。算了，反正事情已经发生了，再计较什么也无济于事。目前最重要的是，接下来我们究竟应该做些什么……", 9130000);
    } else if (status === i++) {
        qm.sendNextPrev_Illus("这还用说吗？无论是身在日本还是“这边”，我们的任务都只有一个，那就是打倒信长。", 9130009);
    } else if (status === i++) {
        ...
        qm.sendNextPrev_Illus("神那，你过来一下，我有点话要对你说。");
    } else {
        qm.forceStartQuest();
        qm.dispose();
    }
