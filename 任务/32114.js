...
function start(mode, type, selection) {
    if (mode == 1)
        ...
        status--;
    if (status == 0) {
        qm.askAcceptDecline("The girls dormitories are laid out just like the boys', on the end of each floor. I don't know if I'm supposed to be looking around in ladies' rooms though.?");
    } else if (status == 1) {
