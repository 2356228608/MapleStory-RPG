...
function start(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        qm.sendNextPrev("嗯？破坏箱子的方法是？啊，用一般攻击就可以破坏箱子了。..#b以一般攻击#k破坏箱子， #b对付怪物则是用技能攻击#k比较好的样子？那麽就?L集5个试炼的印记吧。");
    } else if (status == 4) {
        qm.forceStartQuest();
        qm.effect_OnUserEff("Effect/OnUserEff.img/guideEffect/cygnusTutorial/9");
        qm.dispose();
    }
}
