...
function start(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            qm.sendNextSNoESC("Kyrin noi rang ong la mot nguoi lam sung rat gioi, va chuyen loi cam on ve khau sung voi ong.");
        } else if (status == 2) {
            ...
            qm.sendNextSNoESC("Khong van de gi. Hay dua toi den do");
        } else if (status == 5) {
            qm.forceStartQuest();
            qm.warp(552000072, 1);
