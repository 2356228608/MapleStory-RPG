...
function start(mode, type, selection) {
    ...
    if (status == 0) {
        qm.askMenu("Welcome to Red Leaf High, new kid! Stick around a while and I bet you'll build up lots of Friendships. Not sure how Friendship works? Lemme spill the beans!#b\r\n#L0# What's Friendship? #l\r\n#L1# View current Friendship level#l\r\n#L2# End Conversation #l");
    } else if (status == 1) {
        if (selection == 0) {
