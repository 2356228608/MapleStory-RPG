...
function end(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        qm.askYesNo("虽然寒碜了点，不过#b先拿这把剑用着吧#k。算是送给英雄的礼物。英雄如果没有武器，岂不是会有些奇怪？\r\n\r\n\r\n#v1302000# 1个 #t1302000#\r\n\r\n\r\n 35 exp");
    } else if (status == 5) {
        qm.sendNextS("#b（看自己这技能水平没一点英雄的样子……这把剑感觉也很陌生。以前的我是用剑的吗？这把剑怎么用呢？）#k");
    } else if (status == 6) {
        ...
        qm.hireTutorMsg(0x11); // How to equip shiet
		qm.getEA();
        qm.dispose();
    }
}