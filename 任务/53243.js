    ...
    if (mode == -1) {
        ...
        if (qm.getQuestStatus(53243) != 1) {
            if (status == 0) {
                ...
                qm.sendNextSNoESC("(Co ve day se la nguoi minh can tim...)");
            } else if (status == 2) {
                qm.forceStartQuest();
                qm.dispose();
            }
            ...
            if (status == 0) {
                ...
                qm.sendNextSNoESC("Binh tinh nao. #p2111007# da bao toi den day");
            } else if (status == 2) {
                qm.sendNext("Phu`...tu khi nhan viec nay toi khong the ngu noi!");
            } else if (status == 3) {
                qm.sendNextSNoESC("Trong anh co ve rat met moi!");
            } else if (status == 4) {
                ...
                qm.sendNextSNoESC("(1 co may co the pha huy hon da...Nghe that la lung va minh khong thich no cho lam)");
            } else if (status == 6) {
                qm.sendNextSNoESC("Day la nhung nguyen lieu anh can.");
            } else if (status == 7) {
