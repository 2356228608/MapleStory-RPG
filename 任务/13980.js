...
function start(mode, type, selection) {
    ...
    if (status == 0) {
        qm.askAcceptDeclineNoESC("Hello, #b#h0##k! Now that RED is here, it's time to challenge yourself with some exciting achievements. Go the extra mile to earn your goodies! What do you say?");
    } else if (status == 1) {
