...
function start(mode, type, selection) {
    if (mode == 1)
        ...
        status--;
    if (status == 0) {
        qm.askAcceptDecline("Starting today, you'll bee seeing a whole new Gachapon around Maple World. I know, because I have a whole storage closet full of OLD Gachapon and it's drive me insane... Do you want to hear about it?");
    } else if (status == 1) {
