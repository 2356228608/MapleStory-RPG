...
function start(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        qm.askAcceptDecline("Now, do you want to use this character to #bmake Gingerbread Men?#k Think this through, because #ronly one character per nexonID may complete the Gingerbread Man event.)#k");
    } else if (status == 5) {
