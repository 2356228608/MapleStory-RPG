...
function start(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        qm.askYesNo("如果你真的想成为弓箭手，我就用转职官的特权，邀请你到#b射手村的弓箭手培训中心#k来。#r如果你想选择其他职业，可以拒绝。我会帮助你走上其他道路的#k……你想成为弓箭手吗？");
    } else if (status == 3) {
        qm.warp(100000201);
        qm.forceStartQuest();
        qm.dispose();
    } else if (status == 4) {
        qm.askMenu("你想选择其他职业啊……虽然不无遗憾，但这是你自己的选择……那在弓箭手之外，你想选择哪条道路呢？\r\n#b#L1#战士#l \r\n#b#L2#魔法师#l \r\n#b#L4#飞侠#l \r\n#b#L5#海盗#l");
    } else if (status == 5) {
        if (selection == 1) {
...
function end(mode, type, selection) {
    status++;
    if (status == 0) {
        qm.askYesNo("很高兴能在这里见到你……我来把你变成弓箭手吧。做好心理准备了吗？临阵退缩的人，不配成为弓箭手。");
    } else if (status == 1) {
        if (mode == 1) {
