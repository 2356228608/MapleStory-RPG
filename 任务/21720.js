...
function end(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        qm.askYesNo("Scared? Pfft. Who cares if the Black Mage appears. You'll be here to protect us. If anything, this makes me want to prepare you for the big battle. Ah, that reminds me, I found a #bskill#k. Would you like to see it?");
    } else if (status == 7) {
        ...
        qm.effect_OnUserEff("Effect/BasicEff.img/AranGetSkill");
