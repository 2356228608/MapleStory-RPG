...
function start(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        qm.askYesNo("我好像说得太多了……你快决定吧。到底是成为海盗，还是选择其他职业？如果想成为海盗，我就使用转职官的特权，马上邀请你到诺特勒斯号去。#r拒绝的话，我会建议你选择其他职业。请别担心#k。");
    } else if (status == 6) {
        qm.warp(120000101);
        qm.forceStartQuest();
        qm.dispose();
    } else if (status == 7) {
        qm.askMenu("你想选择海盗以外的其他道路吗？这也不坏。那你想选择什么职业呢？ \r\n#b#L1#战士#l \r\n#b#L2#魔法师#l \r\n#b#L3#弓箭手#l \r\n#b#L4#飞侠#l");
    } else if (status == 8) {
        if (selection == 1) {
...
function end(mode, type, selection) {
    status++;
    if (status == 0) {
        qm.askYesNo("很高兴能在这里见到你……干嘛这么吃惊？我看上去太年轻了吗？其实我的年纪比看上去要大得多，你可别小看我。好了，我马上让你转职成海盗。");
    } else if (status == 1) {
        if (mode == 1) {
