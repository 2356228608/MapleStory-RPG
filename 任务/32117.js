...
function start(mode, type, selection) {
    if (mode == 1)
        ...
        status--;
    if (status == 0) {
        qm.askAcceptDecline("Do you know Arwen or Rowen from Ellinia? They are former Ellinel Fairy Academy graduates. They might know of some places we teachers do not.\r\n\r\n #b#e(You will be moved to Ellinia if you accept.)");
    } else if (status == 1) {
