...
function start(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        qm.askYesNo("你看上去好像充分具备成为魔法师的素质……你想成为魔法师吗？接受的话，我就使用转职官的特权，邀请你到#b魔法密林的魔法图书馆#k去。和我见个面，然后帮你转职。#r但是就算拒绝，也不是没有别的路可走。拒绝的话，我可以为你介绍魔法师以外的职业。#k");
    } else if (status == 3) {
        qm.warp(101000003);
        qm.forceStartQuest();
        qm.dispose();
    } else if (status == 4) {
        qm.askMenu("你不喜欢魔法师之路吗？很遗憾。但是我尊重你的选择。那你想走哪条道路呢？\r\n#b#L1#战士#l \r\n#b#L3#弓箭手#l \r\n#b#L4#飞侠#l \r\n#b#L5#海盗#l");
    } else if (status == 5) {
        if (selection == 1) {
...
function end(mode, type, selection) {
    status++;
    if (status == 0) {
        qm.askYesNo("很高兴能在这里见到你……我来把你变成魔法师吧。做好心理准备了吗？临阵退缩的人，不配成为魔法师。");
    } else if (status == 1) {
        if (mode == 1) {
