...
function start(mode, type, selection) {
    ...
    if (status == 0) {
        qm.askYesNo("A powerful barrier of magic, huh? Then what should we do...? If we can't find a way to break that barrier, then we can't save the princess. If it's impossible to physically break through, as you mentioned, then how about requesting help from our #bMinister of Magic#k?");
    } else if (status == 1) {
        qm.forceStartQuest();
