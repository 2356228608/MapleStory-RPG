...
function end(mode, type, selection) {
    ...
    /*	if (mode == -1) {
     ...
     if (status == 0)
     qm.askMenu("Hello, traveler... You have finally come to see me. Have you fulfilled your duties? \r\n #b#L0#What duties? Who are you?#l#k");
     else if (status == 1) {
     ...
     qm.askYesNo("Now do you understand? Every action comes with consequences, and pets are no exception. The egg of the snail shall hatch soon.");
     } else if (status == 6) {
