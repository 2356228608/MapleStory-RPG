...
function start(mode, type, selection) {
    ...
    if (status == 0) {
        qm.askYesNo("Now that i've thought about it, I bet those aliens were trying to catch anybody that saw them before they could tell the rest of us! We have to get them out and spread the word!");
    } else if (status == 1) {
