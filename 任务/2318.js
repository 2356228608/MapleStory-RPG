...
function start(mode, type, selection) {
    ...
    if (status == 0) {
        qm.askYesNo("Hmmm... I looked into the making of the Spores while you were gathering up the Poison Mushroom Caps, and realised that we'll need more materials for it. I want you to gather up one more set of items. Can you do it?");
    } else if (status == 1) {
        qm.forceStartQuest();
