...
function start(mode, type, selection) {
    if (mode == 1)
        ...
        status--;
    if (status == 0) {
        qm.askAcceptDecline("My goodness! My goodness! Always so busy. If you help me, out of the graciousness of your big heart, I may be able to give you something that you'll find useful--in the name of the Witch Malady!");
    } else if (status == 1) {
