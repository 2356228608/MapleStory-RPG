...
function start(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        qm.askAcceptDecline("I bet those #r#o3501004##k things got some of the notes... I saw you fighting a moment ago, and you were relatively good at it. Maybe you can get one or two of those #bSchoolboys' Note#k notes back?");
    } else if (status == 7) {
