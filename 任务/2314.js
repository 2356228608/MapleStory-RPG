...
function start(mode, type, selection) {
    ...
    if (status == 0) {
        qm.askYesNo("In order to rescue the princess, you must first navigate the Mushroom Forest. King Pepe set up a powerful barrier forbidding anyone from entering the castle. Please investigate this matter for us.");
    } else if (status == 1) {
