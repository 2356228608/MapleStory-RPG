...
function start(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        qm.sendNextS("哦，你应该还没有忘记使用技能的方法吧？#b将技能拖到快捷栏上，以方便使用#k。除了技能以外，消费道具也可以拖到这里来方便使用。");
    } else if (status == 5) {
        qm.hireTutorMsg(0x11);
        qm.dispose();
    }
}
...
function end(mode, type, selection) {
    ...
    if (status == 0) {
        qm.askYesNo("嗯……看你的表情就知道你啥都没想起来。不过不用担心。说不定这反倒更好。来，这里有一些药水，加油吧！\r\n\r\n\r\n#v2000022# 10个 #t2000022#\r\n#v2000023# 10个 #t2000023#\r\n\r\n\r\n 57 exp");
    } else if (status == 1) {
        qm.gainItem(2000022, 10);
        qm.gainItem(2000023, 10);
        qm.gainExp(57);
        qm.forceCompleteQuest();
        qm.sendOkS("#b(就算我真的是英雄……一个什么能力都没有的英雄又能有什么用呢？)#k");
        qm.dispose();
    }
}