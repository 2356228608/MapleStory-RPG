...
function start(mode, type, selection) {
    ...
    if (status == 0) {
        qm.askYesNo("Now you'll be able to penetrate the spiny vine barrier of Mushroom Forest, but before that, #bMinister of Home Affairs#k wants to have a word with you. Please go see him immediately.");
    } else if (status == 1) {
        qm.forceStartQuest();
        qm.sendOk("Good luck.");
        qm.dispose();
