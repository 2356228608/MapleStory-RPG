 ...
 */
 ...
 var weaponList = Array(
 	Array(1073030, "埃苏莱布斯骑士鞋"),
	Array(1073032, "埃苏莱布斯法师鞋"),
	Array(1073033, "埃苏莱布斯弓箭手鞋"),
	Array(1073034, "埃苏莱布斯飞侠鞋"),
	Array(1073035, "埃苏莱布斯海盗鞋")
 );
 var potList = Array(
	...
	function action(mode, type, selection) {
		...
		if (status == 0) {
			...
			if (im.getInventory(1).isFull(1)) {
				im.playerMessage(1, "【SS级埃苏莱布斯鞋子箱】\r\n(SS级埃苏莱布斯鞋子箱)\r\n\r\n装备栏空间不足，需要一格空间。");
				cm.safeDispose();
				return;
			} 
			...
			sentWeapon(itemid);
			cm.gainItem(2437538, -1);
			im.worldMessage("公告事项" + " : " + "恭喜玩家 " + im.getChar().getName() + " 从SS级埃苏莱布斯鞋子箱中获得了SS级"+weaponList[selection][1]+"一个");
