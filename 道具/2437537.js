 ...
 */
 ...
 var weaponList = Array(
 	Array(1052882, "埃苏莱布斯骑士套装"),
	Array(1052887, "埃苏莱布斯魔法师套装"),
	Array(1052888, "埃苏莱布斯弓箭手套装"),
	Array(1052889, "埃苏莱布斯飞侠套装"),
	Array(1052890, "埃苏莱布斯海盗套装")
 );
 var potList = Array(
	...
	function action(mode, type, selection) {
		...
		if (status == 0) {
			...
			if (im.getInventory(1).isFull(1)) {
				im.playerMessage(1, "【SS级埃苏莱布斯套装箱】\r\n(SS级埃苏莱布斯套装箱)\r\n\r\n装备栏空间不足，需要一格空间。");
				cm.safeDispose();
				return;
			} 
			...
			sentWeapon(itemid);
			cm.gainItem(2437537, -1);
			im.worldMessage("公告事项" + " : " + "恭喜玩家 " + im.getChar().getName() + " 从SS级埃苏莱布斯套装箱中获得了SS级"+weaponList[selection][1]+"一个");
