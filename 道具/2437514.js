 ...
 var potList = Array(
	...
	function action(mode, type, selection) {
		...
		if (status == 0) {
			...
			sentWeapon(itemid);
			cm.gainItem(2437514, -1);
			im.worldMessage("公告事项" + " : " + "恭喜玩家 " + im.getChar().getName() + " 从伊利温埃苏莱布斯箱子中获得了SS级伊利温"+weaponList[selection][1]+"一个");
			im.sendOk("恭喜您，获得了" + itemnum + "个伊利温的#b#z" + itemid + "#");
			im.dispose();
		}
	}
