 ...
 */
 ...
 var weaponList = Array(
 	Array(1004422, "埃苏莱布斯骑士头盔"),
	Array(1004423, "埃苏莱布斯法师帽"),
	Array(1004424, "埃苏莱布斯弓箭手帽"),
	Array(1004425, "埃苏莱布斯飞侠帽"),
	Array(1004426, "埃苏莱布斯海盗帽")
 );
 var potList = Array(
	...
	function action(mode, type, selection) {
		...
		if (status == 0) {
			...
			if (im.getInventory(1).isFull(1)) {
				im.playerMessage(1, "【SS级埃苏莱布斯帽子箱】\r\n(SS级埃苏莱布斯帽子箱)\r\n\r\n装备栏空间不足，需要一格空间。");
				cm.safeDispose();
				return;
			} 
			...
			sentWeapon(itemid);
			cm.gainItem(2437536, -1);
			im.worldMessage("公告事项" + " : " + "恭喜玩家 " + im.getChar().getName() + " 从SS级埃苏莱布斯帽子箱中获得了SS级"+weaponList[selection][1]+"一个");
