    ...
    if (status == 1) {
        switch (selection) {
            case 0:
                ...
                toDrop.setInt(lvint);
                toDrop.setLuk(lvluk);
                toDrop.setMatk(lvmatk);
                toDrop.setWatk(lvwatk + 171);
                toDrop.setBossdamage(lvbossDamage + 30);
                toDrop.setIgnorepdr(lvIgnorePDR + 10);
                toDrop.setTotaldamage(lvtotalDamage);
                toDrop.setAllstat(lvallStat);
                toDrop.setHp(lvhp);
                toDrop.setMp(lvmp);
                toDrop.setWdef(lvwdef);
                toDrop.setMdef(lvmdef);
                toDrop.setUpgradeSlots(lvUpgradeSlots + 8);
            ...
            case 5:
                ...
                toDrop.setMatk(lvmatk + 201);
                toDrop.setWatk(lvwatk + 119);
                toDrop.setBossdamage(lvbossDamage + 30);
                toDrop.setIgnorepdr(lvIgnorePDR + 10);
                toDrop.setTotaldamage(lvtotalDamage);
                toDrop.setAllstat(lvallStat);
            ...
            case 9:
                ...
                toDrop.setInt(lvint + 40);
                toDrop.setLuk(lvluk + 40);
                toDrop.setMatk(lvmatk + 204);
                toDrop.setWatk(lvwatk + 126);
                toDrop.setBossdamage(lvbossDamage + 30);
                toDrop.setIgnorepdr(lvIgnorePDR + 10);
                toDrop.setTotaldamage(lvtotalDamage);
                toDrop.setAllstat(lvallStat);
