 ...
 */
 ...
 var weaponList = Array(
 	Array(1082636, "埃苏莱布斯骑士手套"),
	Array(1082637, "埃苏莱布斯法师手套"),
	Array(1082638, "埃苏莱布斯弓箭手手套"),
	Array(1082639, "埃苏莱布斯飞侠手套"),
	Array(1082640, "埃苏莱布斯海盗手套")
 );
 var potList = Array(
	...
	function action(mode, type, selection) {
		...
		if (status == 0) {
			...
			if (im.getInventory(1).isFull(1)) {
				im.playerMessage(1, "【SS级埃苏莱布斯手套箱】\r\n(SS级埃苏莱布斯手套箱)\r\n\r\n装备栏空间不足，需要一格空间。");
				cm.safeDispose();
				return;
			} 
			...
			sentWeapon(itemid);
			cm.gainItem(2437539, -1);
			im.worldMessage("公告事项" + " : " + "恭喜玩家 " + im.getChar().getName() + " 从SS级埃苏莱布斯手套箱中获得了SS级"+weaponList[selection][1]+"一个");
