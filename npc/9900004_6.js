...
var wi141 = "#fUI/UIPVP.img/MiniMapIcon/star#";  //黄星星
...
function action(mode, type, selection) {
    ...
    if (cm.getMapId() == 180000001) {
        ...
        var selStr = "#n#k#L0#" + wi15 + "杂货商店#l #L1#" + wi15 + "火炮装备#l #L2#" + wi15 + "双刀装备#l\r\n";
        selStr +="#L3#" + wi15 + "飞标专卖#l #L4#" + wi15 + "暴君商店#l #L5#" + wi15 + "外星装备#l\r\n";
		selStr += "#L6#" + wi15 + "特殊装备#l #L7#" + wi15 + "狮王道具#l #L8#" + wi15 + "征服币店#l\r\n";
        selStr += "#L9#" + wi15 + "普通卷轴#l #L10#" + wi15 + "运动币店#l #L11#" + wi15 + "RED币商#l\r\n";
        selStr += "#L12#" + wi15 + "(技能书)店#l #L25#" + wi15 + "购买重置SP卷#l #L35#" + wi15 + "购买理发卷#l\r\n";
        selStr += "#e#r#L50#" + wi15 + "兑换中心" + wi15 + "#l#L100#" + wi15 + "蜡笔专卖" + wi15 + "#l\r\n";
        selStr += "#d#L14#" + wi15 + "双倍道具#l#L15#" + wi15 + "道具卷轴#l#L16#" + wi15 + "伤害皮肤#l\r\n";
        selStr += "#L17#" + wi15 + "新职业武器#l#L18#" + wi15 + "魔方，喇叭，其他" + wi15 + "#l\r\n";
        selStr += "#d#L19#" + wi15 + "实惠礼包#l#L20#" + wi15 + "绝版时装#l#L21#" + wi15 + "稀有椅子#l\r\n";
        selStr += "#L22#" + wi15 + "上乘装备#l#L23#" + wi15 + "极品卷轴#l#L24#" + wi15 + "品级副装购买#l\r\n";
        selStr += "#d#e#L13#" + wi15 + "兑换道具#l#L26#" + wi15 + "绝版椅子#l#L27#" + wi15 + "140顶级副手#l\r\n";
        selStr += "#d#e#L29#" + wi15 + "抵用时装#l#L30#" + wi15 + "巨匠装备#l#L28#" + wi15 + "极品机器人#l\r\n";
		selStr += "#d#e#L200#" + wi15 + "神秘套装#l #L201#" + wi15 + "神秘武器#l #L202#" + wi15 + "创世武器店#l";
        cm.askMenu(selStr);
    } else if (status == 1) {
        switch (selection) {
            case 202:
                cm.dispose();
                cm.openNpc(9310144, "创世武器非神装");
                break;
			case 201:
                cm.dispose();
