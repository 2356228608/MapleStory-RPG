...
function start() {
    mapid = cm.getMapId();
    if (mapid == 925020001) {
        cm.askMenu("师父是这里的第一强者。像你这种家伙也敢挑战？你会后悔的。 #b\r #L0#单人模式#l \n\r #L2#兑换腰带#l \n\r #L4#武陵道场说明#l \n\r #L6#武陵道场是什么#l \n\r #L8#我想看看我的道场积分#l\n\r #L7##b我想知道我的数据#l");
    } else {
        cm.askYesNo("waaat?do you want to quit?");
    }
}
    ...
    if (mapid == 925020001) {
        ...
        if (status == 0) {
            ...
            if (sel == 0) {
                ...
                typed = 1;
                cm.askMenu("道场分3个楼层,选择适合你的楼层进行挑战吧。#b\r\n#L0#挑战楼层1(90级以上)#l \r\n#L1#挑战楼层2(120级以上)#l \r\n#L2##r挑战楼层1(180级以上)#l");
            }
            if (sel == 2) {//was3
                typed = 2;
                cm.askYesNo("I'll give you a #bbelt#k if you have some #b#i4001620# #t4001620##k. This belt will disappear after a week though, so collect those Mu Gong's Emblems again if you want another.");
            }
            if (sel == 4) {
                typed = 4;
                cm.askMenu("You can collect #t4001620#s on any difficulty level, though you'll get more in #bHard Mode#k and #bRanked Mode#k. Once you have enough #t4001620#s, you can exchange them for one of #bMu Gong's Belts#k.#b \n\r #L0#What types of Mu Gong's Belts are there?#l \n\r #L1#What rewards can be earned in Hard Mode and how do I earn them?#l \n\r #L2#What rewards can be earned in Ranked Mode and how do I earn them?#l");
                //cm.askMenu("You'll be rewarded points based on how well you did in Hard Mode. \r\n#eyou have #r"+cm.getDojoPoints()+" Points#b\n\r #L0# #v2022957# #b#z2022957##r (50 points required)#l \n\r #L1# #v1142386# #b#z1142386##r (50 points required)#l \n\r #L2##b#e Grade SS: #i1022135:# #t1022135# (Duration: 7Days)#r(100 points required)#b#l \n\r #L3# Grade S: #i1022136:# #t1022136# (Duration: 7Days)#r(50 points required)#l");
            }
            if (sel == 5) {
                typed = 5;
                cm.askMenu("To earn a reward in Ranked Mode, you have to be ranked one of the top 50 players! You'll be competing for the best time against other players for these rewards. Think YOU've got what it takes? Puh-lease! But you should still try.\r\n#e < Ranked Mode Rewards: 7 Day Duration>#n#b\n\r #L0# #i1082392:# #t1082392# #r(Rank 1)#b#l \n\r #L1# #i1082393:# #t1082393# #r(Ranks 2-10)#b#l \n\r #L2# #i1082394:# #t1082394# #r(Ranks 11-50)#l");
            }
            if (sel == 6) {
            ...
            if (sel == 7) {//todo finish
                cm.askMenu("Yikes, you currently only have #b" + cm.getDojoPoints() + "#k points. That's not even enough to reach Grade B. To get to Grade B, you need 100000 points. Work HARDER. Pretend you're ME!");
                cm.dispose();
            }
            ...
            if (typed == 4) {
                ...
                if (selection == 1) {
                    cm.askMenu("You'll be rewarded points based on how well you did in Hard Mode. Points add up each week to put you in a certain Grade. You can then get rewards based on what Grade you achieved. You'll have to work REALLY hard if you want to achieve anything with muscles like that... \r\n #e <Hard Mode Rewards> \r\n #b#e Grade SS: #i1022135:# #t1022135# #r(Duration: 7 Days)#b \r\n Grade S: #i1022136:# #t1022136# #r(Duration: 7 Days)#b \r\n Grade A: #i2022957:# #t2022957# x3 #r(Duration: 7 Days)#b \r\n Grade B: #i2001505:# #t12001505# x10 #r(Duration: 7 Days)#b");
                    cm.dispose();
                    //	if(cm.getDojoPoints()>=50){
                    //		cm.setDojoRecord(false, true, -50);
