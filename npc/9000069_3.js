...
//Array(2047818, 50), // - 惊人的双手武器攻击力卷轴100% - 在双手武器上附加提升攻击力的属性。
//Array(2046996, 50), // - 惊人的单手武器攻击力卷轴100% - 对单手武器增加攻击力提高属性。
//Array(2046997, 50) // - 惊人的单手武器魔力卷轴100% - 对单手武器增加魔力提高属性。
    ...
    if (mode == -1) {
        ...
        if (a == -1) {
            ...
            for (var i = 0; i < itemlist.length; i++) {
                text += "#L" + i + "##i" + itemlist[i] + ":##t" + itemlist[i] + "# - #r" + itemlist[i][1] + "#b蜗牛邮票  \r\n";
                if (i != 0 && (i + 1) % 5 == 0) {
                    text += "\r\n";
                }
            }
            ...
            selects = selection;
            cm.askNumber("请输入你请你输入想要购买的数量\r\n\r\n#r1个需要" + itemlist[selects][1] + "个#b蜗牛邮票#k", 0, 0, 999999);
        } else if (a == 2) {
            buynum = selection;
