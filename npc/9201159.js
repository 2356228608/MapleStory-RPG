...
function action(mode, type, selection) {
    ...
    status++;
    if (status == 0) {
        cm.askMenu("Hello! I'm the #r#eVoting Point NPC#n#k. If you have voted on our site, you will get a point each time! I see you have #e#r" + cm.getPlayer().getVPoints() + "#n#k voting points! I can redeem your points for cool things! What would you like...?\r\n\r\n#b#L0#Trade for Common Items#l\r\n#L1#Trade for Special Items#l\r\n#L2#Trade for Royal Hair(35 vote points)#l\r\n#L3#Trade for Minigame Item#l\r\n#L4#Reset ALL AP (35 vote points) (DOES NOT reset HP or MP)#l#k");
    } else if (status == 1) {
        status += selection;
        var selStr;
        var it;
