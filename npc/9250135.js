...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        cm.sendNextSNoESC("I'm not walking outta here until I clear this mess up!");
    } else if (status == 1) {
        ...
        cm.sendNextSNoESC("You think is was an inside job? Someone at the palace?");
    } else if (status == 3) {
        cm.sendNextSNoESC("I guess they didn't think too hard about who they picked to run a scheme on... Somebody's gonna pay for running my day.");
    } else if (status == 4) {
