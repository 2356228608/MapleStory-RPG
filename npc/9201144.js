    ...
    switch (selection) {
        ...
        case 1:
            ...
            if (prop.equals("0") || prop == null) {
                ...
                cm.askMenu("Another party has already entered the #rParty Quest#k in this channel. Please try another channel, or wait for the current party to finish.#b\r\n#L0#I want the Rice Cake Hat.#");
            }
            break;
        default:
            cm.dispose();
