...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        if (selection == 0) {
            beauty = 1;
            cm.askYesNo("If you use the regular coupon, you'll be assigned a random pair of cosmetic lenses. Do you still want to use #b#t5152010##k and make the change to your eyes?");
        } else if (selection == 1) {
            beauty = 2;
            cm.setAvatar("With our specialized machine, you can see yourself after the treatment in advance. What kind of lens would you like to wear? Choose the style of your liking.", hair_Colo_new);
        }
    } else if (status == 2) {
        if (beauty == 1) {
