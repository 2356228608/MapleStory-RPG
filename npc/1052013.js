        ...
        if (status == 0) {
            ...
            if (selection == 0) { //how i evolve
                ...
                if (evo == 0) {
                    ...
                    if (cm.haveItem(battlers.get(sel).getFamily().evoItem.id)) {
                        cm.askMenu(selStr + "#L0##v" + battlers.get(sel).getFamily().evoItem.id + "##z" + battlers.get(sel).getFamily().evoItem.id + "##l");
                    } else {
                ...
                cm.askYesNo("Are you sure you want to release the monster " + battlers.get(sel).getName() + " (#o" + battlers.get(sel).getMonsterId() + "#)?");
            } else if (selection == 3) {
                cm.askText("Please enter the new name for your monster. (Min: 2 characters, Max: 20 characters)");
            } else if (selection == 5) {
            ...
            if (sec == 0) {
                if (cm.haveItem(battlers.get(sel).getFamily().evoItem.id)) {
                    ...
                    cm.getPlayer().changedBattler();
                    cm.fieldEffect_PlayFieldSound("5th_Maple/gaga");
