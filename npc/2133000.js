    ...
    if (status == 0) {
        ...
        if (selection == 0) {
            ...
            if (cm.getParty() == null) { // No Party
                cm.askYesNo("You need to create a party to do a Party Quest. Do you want to use the Party Search funtion?");
                ...
                if (next) {
                    ...
                    if (em == null || open == false) {
                        cm.askMenu("This PQ is not currently available.");
                        cm.dispose();
                    } else {
                        ...
                        if (prop == null || prop.equals("0")) {
                            ...
                            cm.askMenu("Someone is already attempting the PQ. Please wait for them to finish, or find another channel.");
                        }
        ...
        if (selection == 10) {
            if (cm.haveItem(4001198, 40)) {
                if (!cm.canHold(1032101, 1)) {
                    cm.askMenu("Please make some room for these earrings.");
                }
                ...
                cm.askMenu("I'm afraid this isn't enough. If you want a #b Brilliant Altaire Earrings#k, bring me 40 Altaire Fragments.");
                cm.dispose();
            }
        }
