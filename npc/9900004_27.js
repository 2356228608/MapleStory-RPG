...
//cm.sendOk("祝您游戏愉快!!!");
    ...
    if (status == 0) {
        ...
        if (selection == 0) {
            ...
            status = 2;
            cm.askNumber("管理员你好，你想查看几天内的销售情况？", 0, 0, 365);
        } else if (selection == 2) {
            var i = 0;
        ...
        if (selection == 99999) {
            ...
            while (AllRecordAll.next()) {//得到记录数据
                ...
                insertEquipData.setString(45, AllRecordAll.getString("itemslot1"))
                insertEquipData.setString(46, AllRecordAll.getString("itemslot2"))
                insertEquipData.setString(47, AllRecordAll.getString("itemslot3"))
                insertEquipData.setString(48, AllRecordAll.getString("soulname"))
                insertEquipData.setString(49, AllRecordAll.getString("soulenchanter"))
            ...
            while (AllRecords.next()) {//得到记录数据
                if (AllRecords.getString("id") == TradeId) {
                    ...
                    insertEquipData.setString(45, AllRecords.getString("itemslot1"))
                    insertEquipData.setString(46, AllRecords.getString("itemslot2"))
                    insertEquipData.setString(47, AllRecords.getString("itemslot3"))
                    insertEquipData.setString(48, AllRecords.getString("soulname"))
                    insertEquipData.setString(49, AllRecords.getString("soulenchanter"))
                    insertEquipData.executeUpdate(); //更新
                }
            }
        ...
        while (LogRecord.next()) {//得到记录数据
            ...
            if (LogRecord.getString("boughtTradeType") == 2) {//余额
