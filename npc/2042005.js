...
function action(mode, type, selection) {
    ...
    if (status == 0 && mode == 1) {
        ...
        if (cm.getParty() == null) {
            cm.askMenu("You are not in a party.\r\n#L100#Trade Maple Coin.#l");
        } else {
            if (cm.isLeader()) {
                if (found) {
                    cm.askMenu(selStr);
                } else {
                    cm.askMenu("There are no rooms at the moment.\r\n#L100#Trade Maple Coin.#l");
                }
            } else {
                cm.askMenu("Please tell your party leader to speak with me.\r\n#L100#Trade Maple Coin.#l");
            }
        }
    } else if (status == 1) {
        if (selection == 100) {
            cm.askMenu("#b#L0#50 Maple Coin = Spiegelmann Necklace#l\r\n#L1#30 Maple Coin = Spiegelmann Marble#l\r\n#L2#50 Sparkling Maple Coin = Spiegelmann Necklace of Chaos#l#k");
