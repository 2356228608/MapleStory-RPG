...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        cm.askMenu("What do you want to make?#b\r\n#L0#Moon Rock#l\r\n#L1#Star Rock#l\r\n#L2#Black Feather#l");
    } else if (status == 2) {
        selected = selection;
        if (selection == 0) {
            item = "Moon Rock";
            cm.askYesNo("So you want to make Moon Rock? To do that you need refined one of each of these: #bBronze Plate#k, #bSteel Plate#k,\r\n#bMithril Plate#k, #bAdamantium Plate#k, #bSilver Plate#k, #bOrihalcon Plate#k and #bGold Plate#k. Throw in 10,000 mesos and I'll make it for you.");
        } else if (selection == 1) {
            item = "Star Rock";
            cm.askYesNo("So you want to make the Star Rock? To do that you need refined one of each of these: #bGarnet#k, #bAmethyst#k, #bAquaMarine#k, #bEmerald#k, #bOpal#k, #bSapphire#k, #bTopaz#k, #bDiamond#k and #bBlack Crystal#k. Throw in 15,000 mesos and I'll make it for you.");
        } else if (selection == 2) {
            item = "Black Feather";
            cm.askYesNo("So you want to make Black Feather? To do that you need #b1 Flaming Feather#k, #b1 Moon Rock#k and #b1 Black Crystal#k. Throw in 30,000 mesos and I'll make it for you. Oh yeah, this piece of feather is a very special item, so if you drop it by any chance, it'll disappear, as well as you won't be able to give it away to someone else.");
        }
    } else if (status == 3) {
        if (selected == 0) {
