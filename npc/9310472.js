...
//现金道具
        Array(1004139, 900, 1, 1), //粉嘟嘟熊帽 - (无描述)
        Array(1052754, 900, 1, 1), //嘟嘟熊连体衣 - (无描述)
        Array(1082618, 900, 1, 1), //嘟嘟熊爪 - (无描述)
        Array(1072256, 900, 1, 1), //熊仔鞋 - (无描述)
        Array(1042311, 900, 1, 1), //彩糖T恤 - 由中国冒险岛玩家"小术"设计。
        Array(1062204, 900, 1, 1), //彩糖短裤 - 由中国冒险岛玩家"小术"设计。
        Array(1062221, 900, 1, 1),
        Array(1062222, 900, 1, 1),
        Array(1073013, 900, 1, 1),
        Array(1073014, 900, 1, 1),
        Array(1112915, 900, 1, 1), //蓝调戒指
        Array(1042315, 900, 1, 1),
        Array(1042316, 900, 1, 1),
        Array(1042338, 900, 1, 1),
        Array(1062211, 900, 1, 1),
        Array(1062213, 900, 1, 1),
        Array(1082631, 900, 1, 1)
...
/*function start() {
 status = -1;
 cm.askMenu("冒险岛转蛋机中有各类#b装备、卷轴或稀有新奇的道具#k噢！使用“#b#t5220040##k”就可以交换. 游戏商城中的“其他”－“游戏”区里有噢。 假如不买转蛋券的话，是不可以使用我的。现在要玩转蛋机么？\r\n你可以选择以下转蛋机哦\r\n#L0##p9330112#\r\n#L1##p9330113#\r\n#L2##p9330114#\r\n#L3##p9330115#\r\n#L4##p9330116#\r\n#L6##p9330118#\r\n");
 }
