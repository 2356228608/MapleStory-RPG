...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        cm.askMenu("你听说过的海滩，一个壮观的海洋称为黄金海滩，位于附近的明珠港？我可以带你过去.但是你必须得支付#b1500 金币#k或者你有贵宾卡我可以免费带你过去, 怎么样？\r\n\r\n#L0##b支付金币前往黄金沙滩#l\r\n#L1#使用贵宾卡#l\r\n#L2#如何获得贵宾卡#l");
    } else if (status == 1) {
        if (selection == 0) {
            cm.askYesNo("确定支付#r1500金币#k前往黄金沙滩吗？");
        } else if (selection == 1) {
            status = 2;
            cm.askYesNo("确定使用#r贵宾卡#k前往黄金沙滩吗？");
        } else if (selection == 2) {
            status = 4;
