...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        if (cm.getPlayer().getMapId() == 209000000) {
            cm.askYesNo("Shalom Temple is a place that is unlike anything you've ever seen. It's a great place to take pictures, too. Would you like to go there?");
        } else {
            cm.askYesNo("I hope you enjoyed looking around this temple. Are you ready to return to your original spot?");
        }
    } else if (status == 1) {
        if (cm.getPlayer().getMapId() == 209000000) {
