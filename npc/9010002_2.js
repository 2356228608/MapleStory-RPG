        ...
        if (mode == - 1) {
            ...
            if (a == - 1) {
                ...
                if (selection == 1) {
                    ...
                    cm.sendOk("#b老公老婆戒指升级说明:#k\r\n1.爱心宝石可以通过抽奖、VIP每日福利、活动副本等渠道获得\r\n2.每升1个等级老公老婆戒指需要爱心宝石x10\r\n3.老公老婆戒指LV30的时候每升1个等级需要爱心宝石x200\r\n4.老公老婆戒指LV50的时候最高特殊属性值为魔物攻击力x50");
                    cm.dispose();
                } else if (selection == 2) {
