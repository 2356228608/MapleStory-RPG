...
function action(mode, type, selection) {
    ...
    if (status == -1) {
        cm.askMenu("Hello there~ If you are interested in upgrading or repairing your weapon, you have definitely come to the right place! I'm the best weapon maker in this great town of Leafre. Okay, what do you think about a weapon that is laden with the incredible power of the dragon? Are you interested?\r\n#L0# Create a Dragon weapon#l\r\n#L100# Repair Equipment#l");
    } else if (status == 0) {
        if (selection == 0) {
            ...
            cm.askYesNo("Great! I'll show you what I'm capable of. You are aware that the service fee varies depending on the item's level and amount of Durability the item's lost, aren't you? Would you like to repair your equipment item now?");
            status = 99;
        }
