...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (mode == 1)
            status++;
        if (status == 0) {
            cm.askMenu("你好伟大的#b#h ##k，我是本服发布任务的NPC，本服的的特色任务都在我这里进行哟，当然平时的活动和新加的任务也是这里啦，准备好了吗？\r\n#L0##b正义之章(挣取正义币,黄金罗盘)#l\r\n#L1#我要打工(大量装备游戏币,黄金罗盘)#l\r\n#L4#怪物公园(10种副本,掉落纪念币兑换)#l\r\n");
        } else if (status == 1) {
            if (selection == 0) { //正义之章
                cm.dispose();
