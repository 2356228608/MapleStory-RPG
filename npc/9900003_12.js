...
var EventList = Array(
		...
		Array("#b[每日任务]击败200个喜悦艾尔达[可获得神秘微章]#k#l", 130),
		Array("#b[每日任务]击败200个愤怒艾尔达[可获得神秘微章]#k#l", 131),
		Array("#b[每日任务]击败200个悲伤艾尔达[可获得神秘微章]#k#l", 132),
		Array("#b[每日任务]击败200个快乐艾尔达[可获得神秘微章]#k#l", 133)
		//Array("#b[每日任务]#k#l", 134)
        );
