...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        if (selection == 0) {
            beauty = 1;
            cm.askYesNo("If you use the regular coupon, you'll be awarded a random pair of cosmetic lenses. Are you going to use a #b#t5152011##k and really make the change to your eyes?");
        } else if (selection == 1) {
            beauty = 2;
