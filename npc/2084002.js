...
function action(mode, type, selection) {
    ...
    if (property == "1")
        ...
        select = selection;
        cm.askYesNo("Are you sure you want to buy " + (selection == 0 ? "#i1102207# Goldensoul Cape" : selection == 1 ? "#i1122080# Dragon Lord Necklace" : selection == 2 ? "#i2041213# Dragon Lord Ruby" : "#i2022704# Blessing of the Dragon Lord") + "?\r\nIt will cost you " + (selection == 0 ? "100" : selection == 1 ? "50" : selection == 2 ? "30" : "10") + " Icy Soul Rocks.");
        property = "3";
    } else if (property == "3") {
