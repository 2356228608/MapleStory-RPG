...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            var selStr = head + "#b请选择购买天数：#n#k\r\n";
            selStr += "\r\n  - #e#r您当前冰淇淋为 #d" + cm.getPlayer().getHyPay(1) + "#k#r #e币#n#k\r\n";
            selStr += "       #d您当前的点卷为：#r" + cm.getPlayer().getCSPoints(1) + " #d点#k\r\n\r\n\r\n";
            selStr += "#L2##b" + aaa + " 超级实惠理财服务100冰淇淋/月[详情点击查看]#l#k\r\n\r\n";
            //selStr +="#L3##b"+aaa+" 随身服务包一年权[详情点击查看]#l#k\r\n";
            cm.askMenu(selStr);
        } else if (status == 1) {
            if (selection == 1) {
                typed = 1;
                cm.askYesNo(head + "- #e#d欢迎办理随身服务一天权：#n#k\r\n\r\n- #e#r提示:#k#n  #rvip神秘盒子 10元现金/天#k\r\n\r\n- #e#d随身服务特权：#n#k\r\n\t\t#b每日可以拿3000万金币工资。\r\n\t\t可自主选择发型。可使用快捷洗血功能。\r\n\t\t每日大量魔方，积分，活力，抽奖\r\n\t\t快捷传送，三倍经验，双倍爆率\r\n\t\t购买点卷特权获得双倍，以及专署副本。\r\n\r\n- #e#d管理提示：#n#b点是进行购买。点否返回上一页.#k");
            } else if (selection == 2) {
                typed = 2;
                cm.askYesNo(head + "- #e#d超级实惠理财服务一月权：#n#k\r\n\r\n- #e#r提示:#k#n  #rvip神秘盒子 100000点卷/月#k\r\n\r\n- #e#d服务特权：#n#k\r\n\t\t#b拥有全服上线提示、独特聊天颜色。\r\n- #e#d详细说明：#n#k\r\n\t\t办理后会扣掉您10万点卷，并且分30天返还4.5万点卷30天内每天享有三倍经验以及双倍爆率，并且30天内会返还您90个高级神奇魔方、大师级神奇魔方、防暴卷轴、祝福卷轴。另可享有免费更换发型以及快速洗血。还可以领取每日金币\r\n\r\n- #e#d管理提示：#n#b点是进行购买。点否返回上一页.#k");
            } else if (selection == 3) {
                typed = 3;
                cm.askYesNo(head + "- #e#d欢迎办理随身服务一年权：#n#k\r\n\r\n- #e#r提示:#k#n  #rvip神秘盒子 1200元现金/年#k\r\n\r\n- #e#d随身服务特权：#n#k\r\n\t\t#b每日可以拿30万金币工资。\r\n\t\t可自主选择发型。可使用快捷洗血功能。\r\n\t\t每日大量魔方，积分，活力，抽奖\r\n\t\t快捷传送，三倍经验，双倍爆率\r\n\t\t购买点卷特权获得双倍，以及专署副本。\r\n\r\n- #e#d管理提示：#n#b点是进行购买。点否返回上一页.#k");
            } else if (selection == 4) {
                typed = 4;
                cm.askYesNo("");
            }
