        ...
        if (selection == 0) {
            ...
            if (cm.getParty() == null) { // No Party
                ...
                if (next) {
                    ...
                    cm.askYesNo("组队成员 " + minPlayers + " 人以上 " + maxPlayers + "人 以下 所有成员等级 " + minLevel + " 以上 " + maxLevel + " 以下才可以入场。");
                }
            }
        } else if (selection == 2) {
