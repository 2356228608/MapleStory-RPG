...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        cm.askYesNo("Do you want to enter the Wedding Hall?");
    } else if (status == 1) {
        ...
        if (data.equals("1")) {
            ...
            cm.worldMessage("<Channel " + cm.getClient().getChannel() + "> " + cm.getPlayer().getName() + " and " + chr.getName() + "'s wedding is about to be started.");
        } else {
