...
var items = [
    ...
    /*Other*/ [[1122017, 50000], [2530000, 200000], [2531000, 500000], [3993002, 10000]], // Arcane-Like
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        switch (selection) {
            ...
            case 1:
            case 2:
                cm.askNumber("How many " + (selection == 1 ? "Enchanted Scrolls" : "Bamboo Luck Sacks") + " would you like to trade?\r\n", cm.itemQuantity(selection == 1 ? 5221001 : 3993002), 1, 100);
                break;
            case 3:
            case 4:
            case 5:
