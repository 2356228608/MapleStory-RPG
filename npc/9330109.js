...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        choose = selection;
        if (selection == 0) { //买鱼竿
            cm.askYesNo("钓鱼竿的样子是 #v1432039# ,使用钓鱼竿，可以在钓鱼场里钓鱼哦！当然，鱼饵也是必要的！\r\n\r\n\r\n你是否需要买？\r\n\r\n价格：#b 5E/杆/1天;");
        }
        if (selection == 9) { //买鱼竿
            cm.askYesNo("钓鱼竿的样子是 #v1432039# ,使用钓鱼竿，可以在钓鱼场里钓鱼哦！当然，鱼饵也是必要的！\r\n\r\n\r\n你是否需要买？\r\n\r\n价格：#b 3W消费币/杆/永久;");
        }
        if (selection == 10) { //买双倍爆率卡
            cm.askYesNo("双倍爆率卡的样子是 #v5360015# ,使用双倍爆率卡，可以在高级钓鱼场里钓鱼哦！当然，鱼饵也是必要的！\r\n\r\n\r\n你是否需要买？\r\n\r\n价格：#b 1W消费币/张/1天;");
        }
        if (selection == 11) { //买双倍爆率卡
            cm.askYesNo("双倍爆率卡的样子是 #v5360015# ,使用双倍爆率卡，可以在高级钓鱼场里钓鱼哦！当然，鱼饵也是必要的！\r\n\r\n\r\n你是否需要买？\r\n\r\n价格：#b 20W消费币/张/永久;");
        }
        if (selection == 12) { //买双倍爆率频道票
            cm.askYesNo("双倍爆率频道票的样子是 #v4110002# ,使用双倍爆率频道票，可以在极速钓鱼场里钓鱼哦！当然，鱼饵也是必要的！\r\n\r\n\r\n你是否需要买？\r\n\r\n价格：#b 1W消费币/张/1天;");
        }
        if (selection == 13) { //买双倍爆率频道票
            cm.askYesNo("双倍爆率频道票的样子是 #v4110002# ,使用双倍爆率频道票，可以在极速钓鱼场里钓鱼哦！当然，鱼饵也是必要的！\r\n\r\n\r\n你是否需要买？\r\n\r\n价格：#b 20W消费币/张/永久;");
        }
        if (selection == 14) { //买高级鱼竿
            cm.askYesNo("高级鱼竿的样子是 #v5340001# ,使用高级鱼竿，可以在极速钓鱼场里钓鱼哦！当然，鱼饵也是必要的！\r\n\r\n\r\n你是否需要买？\r\n\r\n价格：#b 2W消费币/杆/1天;");
        }
        if (selection == 15) { //买高级鱼竿
            cm.askYesNo("高级鱼竿的样子是 #v5340001# ,使用高级鱼竿，可以在极速钓鱼场里钓鱼哦！当然，鱼饵也是必要的！\r\n\r\n\r\n你是否需要买？\r\n\r\n价格：#b 25W消费币/杆/永久;");
        }
        if (selection == 1) {
            cm.askText("鱼饵的样子是 #v2300000# ,每 #b" + price1 + "/1条#k,您需要(#b请输入条数#k):");

        }
        if (selection == 2) {
            cm.askText("高级鱼饵的样子是 #v2300001# ,鱼类最爱吃的鱼饵，可以大幅度增加收获量.\r\n 每 " + price2 + "消费币/1条.\r\n,您需要(#b请输入条数#k):");
        }
        if (selection == 3) {
        ...
        if (choose == 1) {
            ...
            cm.askYesNo("购买 #b" + num + " #k条 鱼饵需要：#b" + (num * price1) + " 冒险币.？");
        }
        if (choose == 2) {
            num = parseInt(cm.getText());
            if (num < 0 || isNaN(num)) {
            ...
            cm.askYesNo("购买 #b" + num + " #k条 高级鱼饵需要：#b" + (num * price2) + " 消费币.？");
        }
        if (choose == 3) {
            price_st = calculate();
            if (price_st) {
