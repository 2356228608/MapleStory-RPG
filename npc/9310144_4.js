        ...
        if (status == 0) {
            ...
            if (beauty == 1) {
                ...
                if (cm.getSpace(4) < sl) {
                    ...
                    cm.sendOk("您成功将#r " + (selection * 1000) + " #k点卷换为国庆纪念币#v4000463# x #r" + selection + " #k")
                } else {
                ...
                if (cm.haveItem(4000463, selection)) {
                    ...
                    cm.sendOk("您成功将国庆纪念币#v4000463# x #r" + selection + " #k换为#r " + (900 * selection) + " #k点卷。");
                } else {
