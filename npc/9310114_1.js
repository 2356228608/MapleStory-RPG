...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        cm.askYesNo("天啦，你真的击败蘑菇王了，请务必获取蘑菇王掉落物 #r#t4001318##k，我会赠送您一份小礼物，请务必笑纳。");
    } else if (status == 1) {
        if (cm.haveItem(4001318, 1) == false) {
            ...
            cm.worldSpouseMessage(0x0C, "『英雄救美』" + " : " + "[" + cm.getChar().getName() + "]获得了" + psrw[rand][1] + "个<" + ii.getName(psrw[rand][0]) + ">,快去挑战吧");
            cm.dispose();
        }
    }
}
