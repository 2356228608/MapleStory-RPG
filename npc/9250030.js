...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (mode == 1)
            ...
            status--;
        if (status == 0) {
            cm.askMenu("I'm a hair assistant Limbo in Floating Market. My title might only be assistant, but don't worry! I've got skills! If you have #bFloating Market hair style coupon(REG)#k by any chance, then how about letting me change your hairdo? \r\n#L0##b Haircut(REG coupon)#k#l \r\n#L1##bDye your hair(REG coupon)#k#l");
        } else if (status == 1) {
            if (selection == 0) {
                beauty = 1;
                hairnew = Array();
                ...
                cm.askYesNo("If you use a regular coupon your hair style will change RANDOMLY. Do you still want to use #b#t5150023##k and change it up?");
            } else if (selection == 1) {
                beauty = 2;
                haircolor = Array();
                ...
                cm.askYesNo("If you use a regular coupon your hair color will change RANDOMLY. Do you still want to use #b#t5151018##k and change it up?");
            }
        } else if (status == 2) {
            cm.dispose();
            if (beauty == 1) {
