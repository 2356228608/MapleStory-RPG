...
function action(mode, type, selection) {
    ...
    status++;
    if (status == 0) {
        cm.askMenu("Hello! I'm the #r#eVoting Point NPC#n#k. If you have voted on our site, you will get a point each time! I see you have #e#r" + cm.getPlayer().getVPoints() + "#n#k vote points! I can redeem your points for cool things! What would you like...?\r\n\r\n#b#L0#Trade for Common Items#l\r\n#L1#Trade for Special Items#l\r\n#L2#Additional Pendant Slot(7 Days) for 20 vote points#l\r\n#L3#Trade points for buddy slots#l#k");
    } else if (status == 1) {
        status += selection;
        var selStr;
        var extra = "";
        ...
        if (selection == 0) {
            ...
            cm.askYesNo("Once you proceed with this selection, you can't go back! Are you sure you want Additional Pendant Slot (7 Days) for 20 Vote Points?");
        } else if (selection == 3) {
