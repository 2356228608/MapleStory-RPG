...
function Tutorial3() {
    if (chat == 0)
        ...
        cm.askYesNo("I am going to summon Hilla and everything you need to do is act like you are her #bGuard#k.\r\nDo you accept?");
        yesno = true;
    } else if (chat == 5) {
        yesno = false;
