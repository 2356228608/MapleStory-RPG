...
function action(mode, type, selection) {
    ...
    if (mode == 1)
        ...
        status--;
    if (status == 0) {
        cm.askMenu("If you use this regular coupon, your face may transform into a random new look...do you still want to do it using #b#t5152037##k, I will do it anyways for you. But don't forget, it will be random!\r\n\#L2#OK!#l");
    } else if (status == 1) {
        cm.dispose();
    } else if (selection == 2) {
        facenew = Array();
        ...
        cm.askYesNo("If you use the regular coupon, your face may transform into a random new look...do you still want to do it using #b#t5152037##k?");
    } else if (status == 2) {
