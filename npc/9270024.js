...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        cm.askMenu("Let's see...I can totally transform your face into something new. Don't you want to try it? For #b#t5152038##k, you can get the face of your liking. Take your time in choosing the face of your preference...\r\n\#L2#Let me get my dream face!#l");
    } else if (selection == 2) {
        facenew = Array();
