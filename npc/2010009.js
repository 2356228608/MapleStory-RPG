...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        if (selection == 0) {
            ...
            if (!cm.isLeader()) {
                ...
                if (gs.getAllianceId() > 0) {
                    ...
                    cm.askYesNo("Oh, are you interested in forming a Guild Union?");
            }
        } else if (selection == 3) {
            if (cm.getPlayer().getGuildRank() == 1 && cm.getPlayer().getAllianceRank() == 1) {
                cm.askYesNo("To increase the capacity, you will need to pay 10,000,000 mesos. Are you sure you wish to proceed?"); //ExpandGuild Text
            } else {
        ...
        if (choice == 1) {
            ...
            cm.askText("请输入想要创建家族联盟的名称。(英文最多12字，中文最多6字)");
        } else if (choice == 3) {
        ...
        if (choice == 1) {
            ...
            cm.askYesNo("你确定使用 #b" + guildName + "#k 做为家族联盟的名称吗？");
        }
    } else if (status == 4) {
