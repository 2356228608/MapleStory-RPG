...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        cm.askMenu("...Can I help you?\r\n#L0##bBuy the Magic Seed#k#l\r\n#L1##bDo something for Leafre#k#l\r\n#L2##bI want the Dragon Moss Extract#k#l");
    } else if (status == 1) {
        section = selection;
        if (section == 0) {
            cm.askMenu("You don't seem to be from out town. How can I help you?#L0##bI would like some #t4031346#.#k#l");
        } else if (section == 1) {
        ...
        if (section == 0) {
            cm.askNumber("#b#t4031346##k is a precious iteml I cannot give it to you just like that. How about doing me a little favor? Then I'll give it to you. I'll sell the #b#t4031346##k to you for #b30,000 mesos#k each. Are you willing to make the purchase? How many would you like, then?", 0, 0, 99);
        } else {
        ...
        if (section == 0) {
            if (selection == 0) {
                ...
                temp = selection;
                cost = temp * 30000;
                cm.askYesNo("Buying #b" + temp + " #t4031346#(s)#k will cost you #b" + cost + " mesos#k. Are you sure you want to make the purchase?");
            }
        } else {
            temp = selection;
            if (!cm.haveItem(itemID[temp])) {
                ...
                cm.askNumber("How many #b#t" + itemID[temp] + "#k's would you like to donate?\r\n#b< Owned : #c" + itemID[temp] + "# >#k", 0, 0, "#c" + itemID[temp] + "#");
            }
        }
    } else if (status == 4) {
        if (section == 0) {
            ...
            count = selection;
            cm.askYesNo("Are you sure you want to donate #b" + count + " #t" + itemID[temp] + "##k?");
        }
    } else if (status == 5) {
