    ...
    if (status == 0) {
        ...
        if (selection == 0) {
            ...
            if (cm.getParty() == null) { // No Party
                cm.askMenu("This place is surrounded by the mysterious aura of the full moon, so you can't enter by yourself. If you want to enter, your party leader must talk to me.");
                cm.dispose();
                ...
                cm.askMenu("I'm sorry, but the party you're a member of does NOT consist of at least 2 members. Please adjust your party to make sure that your party consists of at least 2 members that are all at Level 30 or higher. Let me know when you're done.");
                cm.dispose();
            } else {
                ...
                if (next) {
                    ...
                    if (em == null || open == false) {
                        cm.askMenu("This PQ is currently not open.");
                        cm.dispose();
                    } else {
                        ...
                        if (prop == null || prop.equals("0")) {
                            ...
                            cm.askMenu("Someone is already attempting the PQ. Please wait for them to finish, or find another channel."); // may not be a gms copy.. dont have 6 computers to test party inside and party to enter : (
                        }
                    ...
                    cm.askYesNo("Your party is not a party between " + minPlayers + " and " + maxPlayers + " party members. Please come back when you have between " + minPlayers + " and " + maxPlayers + " party members.");
                }
            }
        } else if (selection == 3) {
