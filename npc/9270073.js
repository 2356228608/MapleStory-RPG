...
function action(mode, type, selection) {
    if (mode != 1) {
        ...
        if (status == 0) {
            ...
            cm.askMenu("Each time users collect the required Christmas Decoration, we can set the tree to grow to its maximum!\r\n#b#L0#Here, I brought the Christmas Decoration.#l#k\r\n#b#L1# Please show me the current status on collecting the Christmas Decoration.#l#k");
        } else if (status == 2) {
            if (selection == 0) {
                cm.askNumber("Did you bring the Christmas Decoration with you? Then please give me the #bChristmas Decoration#k you have. How many are you willing to give me?", cm.itemQuantity(4001473), 0, cm.itemQuantity(4001473));
            } else {
