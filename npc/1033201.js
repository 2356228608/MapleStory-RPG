...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        cm.sendNextSNoESC("知道了！阿弗利埃……我们还能再见面吗？……");
    } else if (status == 15) {
        cm.sendNextNoESC("……希望如此。");
    } else if (status == 16) {
        cm.sendNextSNoESC("(虽然很担心同伴们……但是现在只能相信他们。使用回城技能，回村子去吧。)");
    } else if (status == 17) {
