...
var mhair = Array(33000, 33030, 33040, 33050, 33060, 33070, 33080, 33090, 33100, 33110, 33120, 33130, 33150, 33160, 33170, 33180, 33190, 33210, 33220, 33240, 33250, 33270, 33280, 33290, 33350, 33360, 33370, 33380, 33390, 33400, 33440, 33450, 33460, 33500, 33510, 33520, 33580, 33590);
var fhair = Array(34000, 34010, 34020, 34030, 34040, 34050, 34060, 34070, 34080, 34090, 34100, 34110, 34120, 34130, 34140, 34150, 34160, 34180, 34190, 34210, 34220, 34250, 34260, 34270, 34310, 34320, 34330, 34340, 34360, 34400, 34410, 34420, 34450, 34470, 34480, 34490, 34540);
var hairnew;
var itemowner = "Vesper";
...
function action(mode, type, selection) {
    ...
    status++;
    if (status == 0) {
        cm.askMenu("Hello! I'm the #r#eVoting Point NPC#n#k. If you have voted on our site, you will get a point each time! I see that you have #e#r" + cm.getPlayer().getVPoints() + "#n#k vote points! I can redeem your points for cool things! What would you like...?\r\n\r\n#b#L0#Trade for Common Items#l\r\n#L1#Trade for Special Items#l"/* + "\r\n#L2#Trade for Royal Hair(35 vote points)#l\r\n#L3#Trade for Minigame Item#l*/ + "\r\n#L4#Reset ALL AP (20 vote points) (DOES NOT reset HP or MP)#l#k");
    } else if (status == 1) {
        status += selection;
        var selStr;
        var it;
        ...
        if (selection == 0) {
            ...
            cm.askYesNo("Once you proceed with this selection, you can't go back! Are you sure you want to #ereset ALL YOUR AP? (DOES NOT reset HP or MP)#k");
            return;
        } else {
            cm.dispose();
            return;
            ...
            switch (selection) {
                case 0:
                    if (!cm.canHold(cm.isGMS() ? 5211067 : 5211074)) {
                        ...
                        cm.gainItemPeriod(cm.isGMS() ? 5211067 : 5211074, 1, 1, itemowner);
                        passed = true;
                    }
                    break;
                case 1:
                    if (!cm.canHold(cm.isGMS() ? 5211068 : 5211077)) {
                        ...
                        cm.gainItemPeriod(cm.isGMS() ? 5211068 : 5211077, 1, 1, itemowner);
                        passed = true;
                    }
                    break;
                case 2:
                    if (!cm.canHold(cm.isGMS() ? 5360000 : 5360017)) {
                        ...
                        cm.gainItemPeriod(cm.isGMS() ? 5360000 : 5360017, 1, 1, itemowner);
                        passed = true;
                    }
                    break;
                case 3:
                    if (!cm.canHold(4030004)) {
                        ...
                        cm.gainItemPeriod(4030004, 1, 1, itemowner);
                        passed = true;
                    }
                    break;
