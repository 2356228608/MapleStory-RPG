...
function action(mode, type, selection) {
    ...
    if (cm.getMapId() == 180000001) {
		...
		var selStr = "\r\n#e#d#L33#" + cm.getServerName() + "欢迎您。如果您对本服不了解请点这里#n#l#k\r\n";
		selStr +="\r\n#d======================================================#k\r\n";
		selStr +="#L15##r"+ttt6+"在线奖励#l#L17#"+ttt6+"充值奖励#l#k#b#L3#"+ttt6+"组队任务#l#L5#"+ttt6+"点卷中介#l\r\n\r\n";
		selStr +="#b#L11#"+ttt6+"挑战首领#l#L12##r"+ttt6+"重置副本#l#L4##b"+ttt6+"美容美发#l#L14#"+ttt6+"#g解密送点#l\r\n\r\n";
		selStr +="#b#L9#"+ttt6+"#b娱乐副本#l#L19#"+ttt6+"装备制作#l#b#L16#"+ttt6+"绑定商城#b#L21#"+ttt6+"绝版点装#l\r\n\r\n";
		selStr +="#L30##r"+ttt6+"抵用奖励#l#L31#"+ttt6+"男神女神#l#L34#"+ttt6+"寄售系统#l#L35#"+ttt6+"洗血HP#l\r\n\r\n"; 
		selStr +="#L36##r"+ttt6+"OX问答#l  #L37##r"+ttt6+"上乘装备#l#L38##r"+ttt6+"理财系统#l#L39##r"+ttt6+"装备换购#l\r\n";		
		//selStr +="#L30##r"+ttt6+"抵用奖励#l#L31#"+ttt6+"男神女神#l#L22#"+ttt6+"超级神宠#l\r\n\r\n";  
