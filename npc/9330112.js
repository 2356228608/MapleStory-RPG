...
//暴君系列转蛋
        Array(1072743, 50, 1, 1), //暴君西亚戴斯靴
        Array(1082543, 50, 1, 1), //暴君西亚戴斯手套
        Array(1102481, 50, 1, 1), //暴君西亚戴斯披风
        Array(1132174, 50, 1, 1), //暴君西亚戴斯腰带

//冒险之心系列转蛋
        Array(4033755, 800, 1, 0), //心之项链链子
        Array(2431556, 780, 1, 1), //冒险岛勇士之心(战士)
        Array(2431561, 750, 1, 1), //高级冒险岛勇士之心(战士)
//意志肩饰腰带转蛋
    ...
    if (status == 0) {
        ...
        if (finalitem.length != 0) {
            ...
            if (cm.haveItem(5220040) && cm.canHold()) {
                if (notice == 1) {
                    cm.gainGachaponItem(itemId, quantity, "战士转蛋机");
                } else {
