...
var depict = ""; //潜能的描述
var points = -1; //每次的价格
var potline = 3; //修改的潜能是第几条
var oldEquip;
var newEquip;
var count = 1; //定义洗到那个属性的次数
var slot = 1; //定义需要修改的装备在背包的位置
var potline = 3; //定义需要修改的是第几条潜能 [1-3] 为普通 [4-6] 为附加
var Nx = -1;
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        var selStr = "#fUI/UIWindow2.img/Quest/quest_info/summary_icon/summary#\r\n\r\n亲爱的#r#h ##k您好!想选择什么样的潜能:\r\n拥有黄色蜡笔: #r" + cm.itemQuantity(3994419) + "#v3994419##k\r\n\r\n";
        for (var i = 0; i < potList.length; i++) {
            selStr += "\r\n#L" + i + "##b" + potList[i][1] + "#k  \r\n\t#d(需消耗： #r" + potList[i][2] + "#k #k #d黄色蜡笔)#l\r\n";
        }
        cm.askMenu(selStr + " \r\n ");
    } else if (status == 1) {
        ...
        if (cm.itemQuantity(3994419) < 1) {
            cm.sendOk("请确认背包中是否存在#v3994419##t3994419#");
            cm.dispose();
            return;
        }
