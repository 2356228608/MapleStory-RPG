...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            text += Qicon + "今日答题总数: #r" + cm.getBossLog("答题总数") + " #b道#n#k\r\n";
            text += Qicon + "今日正确题目: #r" + cm.getBossLog("答题正确") + " #b道#n#k\r\n";
            ...
            if (selection == 3) {
                ...
                selText += "#L1#" + icon + " 换取(#i5062000#x5#i5064000#x2)(需要答对题目128道)#l\r\n";
            ...
            if (typed == 2) {
                if (selection == 1) {//换取6个魔方和3个防爆卷轴
                    if (cm.getBossLog("答题128兑换") < 1) {
                        if (cm.getBossLog("答题正确") < 128) {
                        ...
                        cm.gainItem(5064000, 2);//防爆卷
                        cm.setBossLog("答题128兑换");
...
var itemtk1 = Array(
        ...
        Array("郊游时，看见野生天涯，您应该怎么做？", "采下来带回家食用", "凭经验判断无毒的就可带回家食用", "咨询围人后感觉安全再食用", "野生的天涯不安全，不采摘也不食用", "4"),
...
var itemtk2 = Array(
        ...
        Array("海?却嬷?己，天涯若比邻是（）的诗句。", "王勃", "李白", "白居易", "杜甫", "2"),
