...
//暴君系列转蛋
        Array(1072744, 50, 1, 1), //暴君赫尔梅斯靴
        Array(1082544, 50, 1, 1), //暴君赫尔梅斯手套
        Array(1102482, 50, 1, 1), //暴君赫尔梅斯披风
        Array(1132175, 50, 1, 1), //暴君赫尔梅斯腰带

//冒险之心系列转蛋
        Array(4033755, 800, 1, 0), //心之项链链子
        Array(2431557, 780, 1, 1), //冒险岛勇士之心(法师)
        Array(2431562, 750, 1, 1), //高级冒险岛勇士之心(法师)
//意志肩饰腰带转蛋
    ...
    if (status == 0) {
        ...
        if (finalitem.length != 0) {
            ...
            if (cm.haveItem(5220040) && cm.canHold()) {
                if (notice == 1) {
                    cm.gainGachaponItem(itemId, quantity, "法师转蛋机");
                } else {
