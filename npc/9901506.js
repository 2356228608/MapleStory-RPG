...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        if (selection == 0) {
            ...
            cm.askYesNo("Cash, is that what you need? Well, I can trade #r#e" + (cm.isGMS() ? (acash / 2) : acash) + " Cash for " + acashp + " points.#n#k. Would you like to accept the offer?");
        } else if (selection == 5) {
            ...
            cm.askYesNo("Once you proceed with this selection, you can't go back! Are you sure you want to #ereset ALL YOUR AP?#k");
        } else if (selection == 9) {
            ...
            cm.askText("Please enter the name you wish to change to.");
            ...
            if (!cm.getPlayer().haveItem(5220013)) {
                ...
                cm.askNumber("How many M Coins would you like to redeem? (1 M Coin = 100 points) (Current M Coins: " + cm.getPlayer().itemQuantity(5220013) + ") (Current Points: " + cm.getPlayer().getPoints() + ")", cm.getPlayer().itemQuantity(5220013), 1, cm.getPlayer().itemQuantity(5220013));
            }
            ...
            if (cm.getPlayer().getPoints() < 100) {
                ...
                cm.askNumber("How many M Coins would you like? (1 M Coin = 100 points) (Current Points: " + cm.getPlayer().getPoints() + ") (Current M Coins: " + cm.getPlayer().itemQuantity(5220013) + ")", cm.getPlayer().getPoints() / 100, 1, cm.getPlayer().getPoints() / 100);
            }
            ...
            if (!cm.getPlayer().haveItem(3993003)) {
                ...
                cm.askNumber("How many Red Luck Sacks would you like to redeem? (1 Red Luck Sack = 1000 points) (Current: " + cm.getPlayer().itemQuantity(3993003) + ") (Current Points: " + cm.getPlayer().getPoints() + ")", cm.getPlayer().itemQuantity(3993003), 1, cm.getPlayer().itemQuantity(3993003));
            }
            ...
            if (cm.getPlayer().getPoints() < 1000) {
                ...
                cm.askNumber("How many Red Luck Sacks would you like? (1 Red Luck Sack = 1000 points) (Current Points: " + cm.getPlayer().getPoints() + ") (Current Red Luck Sacks: " + cm.getPlayer().itemQuantity(3993003) + ")", cm.getPlayer().getPoints() / 1000, 1, cm.getPlayer().getPoints() / 1000);
            }
        } else if (selection == 18) {
            cm.askMenu("#b#L0#30 Days - " + pendantp + " points#l\r\n#L1#90 Days - " + pendantp_perm + " points#l");
        }
    } else if (status == 2) {
        if (sel == 1) {
