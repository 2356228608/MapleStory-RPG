...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        cm.inGameDirectionEvent_Effect("Effect/Direction6.img/effect/tuto/balloonMsg0/10", 2000, 0, -100, 0, 0);
        ...
        cm.inGameDirectionEvent_Effect("Effect/Direction6.img/effect/tuto/balloonMsg1/18", 2000, 0, -100, 0, 0);
        cm.inGameDirectionEvent_AskAnswerTime(1500);
    } else if (status == 29) {
        cm.sendNextS("…连神木村的一草一木都不剩全都消灭掉了...", 5, 2159310);
    } else if (status == 30) {
        cm.inGameDirectionEvent_Effect("Effect/Direction6.img/effect/tuto/balloonMsg1/3", 2000, 0, -100, 0, 0);
        cm.inGameDirectionEvent_AskAnswerTime(1500);
    } else if (status == 31) {
        ...
        cm.inGameDirectionEvent_Effect("Effect/Direction6.img/effect/tuto/balloonMsg0/11", 2000, 0, -100, 0, 0);
        cm.inGameDirectionEvent_AskAnswerTime(1500);
    } else if (status == 37) {
