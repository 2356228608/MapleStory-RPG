...
function action(mode, type, selection) {
    ...
    status++;
    if (status == 0) {
        //cm.askMenu("Hello there, I am trading Cash for items. It seems that you have #r#e" + cm.getPlayer().getCSPoints(1) + "#n#k #rCash#k. You could sure waste some...\r\n\r\n#b#L0#Give me #rCash#b and I'll give you an item.#l#k");
        cm.askMenu("Hi, I like #rCash#k. Maybe you could trade me some of your #r" + cm.getPlayer().getCSPoints(1) + " Cash#k? I have lots of great items for you...#b\r\n\r\n#L0#Cubes#l\r\n#L1#Scrolls#l\r\n#L2#Scrolling Tools#l\r\n#L3#Game-enhancing#l\r\n#L4#Hired Merchant#l\r\n#L5#ETC#l\r\n#L6#Mastery Books#l");
    } else if (status == 1) {
        select = selection;
        ...
        if (items[select][selection][0] / 1000000 == 1) {
            ...
            cm.askNumber("How many would you like? (1#v" + items[select][selection][0] + "##t" + items[select][selection][0] + "# = " + items[select][selection][1] / 2 + " Cash) (Current Cash: " + cm.getPlayer().getCSPoints(1) + ")", 1, 1, cm.getPlayer().getCSPoints(1) / (items[select][selection][1] / 2));
        }
    } else if (status == 3) {
