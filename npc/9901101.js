...
function action(mode, type, selection) {
    ...
    status++;
    if (status == 0) {
        cm.askMenu("Hello, #h0#. I am in charge of the Premium Minidungeons.\r\n\r\n#b#L0#Enter Premium Minidungeon#l#k\r\n#r#L1#Redeem Premium Minidungeon items#l#k");
    } else if (status == 1) {
        selected = selection;
        if (selection == 0) {
            if (cm.haveItem(5451000)) {
                cm.askYesNo("Hello! I see you have #v5451000##t5451000#. Would you like to enter the Premium Minidungeon? #eYou will not be able to use potions. Be prepared.#n");
            } else {
                cm.askYesNo("You will need 30,000,000 mesos to enter this map. Proceed? #eYou will lose HP periodically in the map and you will not be able to use potions. Be prepared.#n");
            }
        } else {
