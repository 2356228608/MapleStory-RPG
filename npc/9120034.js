...
function start() {
    cm.askMenu("How can I help you? \r #b#L0#I want to release seal on Sealed Warrior Stone.#l \r #L1#I want to create item.#l");
}
    ...
    switch (status) {
        case 0:
            if (selection == 0) {
                ...
                status = 9;
                cm.askMenu("How can I help you? \r #b#L0#Magic Throwing Knife#l \r #L1#Armor-Piercing Bullet#l");
            }
            break;
        case 1:
            ...
            break;
        case 2:
            cm.askMenu("Give me the sealed stone \r #b#L0#Give Sealed Warrior Stone and service fee. 1,000 Silver Coin#l \r #L1#Give Sealed Wiseman Stone and service fee. 1,000 Silver Coin#l \r #L2#Give Sealed Saint Stone and service fee. 1,000 Silver Coin#l");
            break;
        case 3:
            if (selection == 0) {
