...
function action(mode, type, selection) {
    if (mode == 0 && status == 1) {
        ...
        if (status == 1) {
            ...
            if (cm.getQuestStatus(1600) == 1 || (cm.getQuestStatus(1600) == 2 && cm.getQuestStatus(1601) < 2) || (cm.getQuestStatus(1601) == 2 && cm.getQuestStatus(1602) < 2)) {
                menu += "#L1600##r[Silent Crusade]#k #bSubway Construction Site#k#l\r\n";
            }
