...
var depict = ""; //潜能的描述
var points = -1; //每次的价格
var potline = 6; //修改的潜能是第几条
var oldEquip;
var newEquip;
var count = 1; //定义洗到那个属性的次数
var slot = 1; //定义需要修改的装备在背包的位置
var potline = 6; //定义需要修改的是第几条潜能 [1-3] 为普通 [4-6] 为附加
var Nx = -1;
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        var selStr = "#fUI/UIWindow2.img/Quest/quest_info/summary_icon/summary#\r\n\r\n#fUI/UIWindow2.img/QuestAlarm/BtQ/normal/0#亲爱的#r#h ##k您好!想选择什么样的潜能:\r\n#k#fUI/UIWindow2.img/QuestAlarm/BtQ/normal/0#拥有蓝色蜡笔: #r" + cm.itemQuantity(3994422) + "#v3994422##k\r\n\r\n#fUI/UIWindow2.img/QuestGuide/Button/WorldMapQuestToggle/normal/0#";
        for (var i = 0; i < potList.length; i++) {
            selStr += "\r\n#L" + i + "##b#fUI/UIWindow2.img/QuestAlarm/BtQ/normal/0#" + potList[i][1] + "#k  (消耗： #r" + potList[i][2] + "#k #k 蓝色蜡笔)#l";
        }
        cm.askMenu(selStr + " \r\n ");
    } else if (status == 1) {
        ...
        if (cm.itemQuantity(3994422) < 1) {
            cm.sendOk("请确认背包中是否存在#v3994422##t3994422#");
            cm.dispose();
            return;
        }
