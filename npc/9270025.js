...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        cm.setAvatar("With our specialized service, you can see the way you'll look after the treatment in advance. What kind of a skin-treatment would you like to do? Go ahead and choose the style of your liking...", skin);
    } else if (status == 1) {
