var status;
var newhandMap = 910000000;        //  进入地图
var SteppedSnailMap = 915010101;  //   羊羊地图
var changeJobMap = 910000000;    //    出去地图
var text;
var freetimes = 0;		     // 免费次数
var basemeso = 300000;	// 起步收费
var needmeso = 0;
        ...
        if (status == 0) {
            ...
            if (selection == 0) {
                ...
                if (canenter) {
                    ...
                    cm.worldSpouseMessage(0x24, "[羊羊提示] : 玩家[" + cm.getPlayer().getName() + "] 参与了 羊羊进行曲 ※ 星星 魔方 享不停 ※ - 加油吧");
                    cm.dispose();
                } else {
                    cm.dispose();
                    return;
