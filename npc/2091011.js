...
function action(mode, type, selection) {
    ...
    switch (status) {
        case 0:
            ...
            switch (sel) {
                case 0:
                    cm.askMenu("在武陵道场中, 通过选择#b普通模式、困难模式、排行榜模式#k, 可以进行挑战。达到#r120级以上#k可以挑战#b\r\r\n\n#L0# 我要挑战#l\r\n");//#L1# 挑战困难模式#l\r\n#L2##r 挑战排行榜模式#l
                    break;
                case 1:
                    cm.askMenu("如果有#b#i4001620# #t4001620##k, 就给你#b腰带#k。不过，这个腰带在 #r#e15天#k#n 之后会消失，如果还想要就再收集武功的证物吧。\r\n\r\n你想领取什么腰带呢？\r\n#b#L0##i1132112:# #t1132112# #r(需要武公的证物25个)#b#l\r\n#L1##i1132113:# #t1132113# #r(需要武公的证物50个)#b#l\r\n#L2##i1132114:# #t1132114# #r(需要武公的证物100个)#b#l\r\n#L3##i1132115:# #t1132115# #r(需要武公的证物125个)#b#l");
                    break;
                case 2:
                    cm.askMenu("武陵道场里，不管是哪个难度模式，只要搜集到#t4001620#就能获得#b武公的腰带#k。如果你挑战#b困难模式#k或#b排名模式#k，还可以获得特殊奖励。当然，能不能拿得到还得看你自己的实力。\r\n#b\r\n#L0#武公的腰带都有什么样的？#l\r\n#L1#挑战困难模式可以获得什么奖励？#l\r\n#L2#怎么做才能在排名模式中获得奖励？#l");
                    break;
                case 3:
                ...
                case 10:
                    cm.dispose();
           cm.openNpc(2091011,"wuling");
                    break;
                case 5:
                    cm.sendOk("今天可以参与#r" + (normLimit - cm.getPQLog("dojonorm")) + "#k次。");
                    cm.dispose();
                    break;
            }
        ...
        case 1:
            switch (sel) {
                case 0://开始道场
                    ...
                    switch (selection) {
                        case 0:
                            if (cm.getChar().getLevel() >= 120) {
                                ...
                                } else if (cm.start_DojoAgent(false, true, 0)) {
                    ...
                    break;
                case 1:
                    var cost, itemID = 1132112 + selection;
                    switch (selection) {
                        case 0:
                            cost = 25;
                            break;
