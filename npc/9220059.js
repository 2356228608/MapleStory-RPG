    ...
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            if (selection == 0) {
                ...
                cm.askYesNo("兑换法弗纳需要集齐#r#e40#k#n个#r#v4310003##t4310003##k，是否进行兑换？");
            }
        } else if (status == 2) {
            if (cm.haveItem(4310003, 40)) {
                ...
                cm.worldSpouseMessage(0x0C, "『系统公告』" + " : " + "恭喜玩家【" + cm.getChar().getName() + "】成功在克劳德处兑换了法弗纳武器箱一个。");
            } else {
