...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        if (Math.floor(Math.random() * 300) == 0) {
            var rareList = new Array(1382047, 1372037, 1382045, 1372035, 1382048, 1382037, 1372039, 1082179, 2340000, 2049100, 1082149, 1102041, 1102084, 1102042);
            ...
            var itemList = new Array(
                    ...
                    2040712, 2040715, 2040714, 2040717, 2040716, 2044305, 2044304, 2040727, 2043805, 2043804, 2040405,
                    2040404, 2040409, 2040408, 2040411, 2040410, 2040407, 2040406, 2043705, 2043704, 1022047,
                    1012056, 1332054, 1102078, 1402017, 2040533, 2040521, 2040520, 2040531, 2040533, 2044803, 2044804,
                    ...
                    1332053, 1322017, 1002022, 1002393, 1432013, 1002395, 1002586, 1082148, 2044904, 2044903,
                    ...
                    2040626, 2040624, 2041026, 2041027, 2041028, 2041029, 2041312, 2041313, 2041314, 2041315,
                    2041316, 2041317, 2041318, 2041319);
