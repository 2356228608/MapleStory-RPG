...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        switch (selection) {
            case 0:
                cm.askYesNo("你去过婚礼村没有？那里是专门为举行简单可爱的婚礼而新建的地方~。据说在那里还能和心爱的人结婚呢。你不觉得这样太浪漫了吗？如果你想去那里，我可以送你过去。怎么样，要去一趟吗？");
                break;
            case 1:
