...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        if (cm.haveItem(4310091, 1000) == false) {
            ...
            cm.worldSpouseMessage(0x0C, "『家园守卫』" + " : " + "[" + cm.getChar().getName() + "]获得了" + psrw[rand][1] + "个<" + ii.getName(psrw[rand][0]) + ">,快去挑战吧");
            cm.dispose();
        }
    }
}
