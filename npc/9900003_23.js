...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        var task = new Array(
                ...
                Array("在线360分钟", 20, 120108),
                Array("在线720分钟", 20, 120109),
                Array("环任务", 25, 120110),
                Array("连续签到", 23, 120111),
                Array("兑换国庆币", 21, 120112),
                Array("兑换点券", 23, 120113),
                Array("提升装备品级", 19, 120114)//cm.finishActivity(120113);
                );
        ...
        if (selection == 100) {
            ...
            cm.worldMessage("[活跃度系统] : 恭喜 " + cm.getChar().getName() + " 完成 " + recevieStage + " 阶段活跃度成功领取礼包。");
        }
        cm.dispose();
    }
}
