                ...
                if (cm.getMapId() == 910002000 && selection == 0) {
                    ...
                    if (cm.getParty() == null) { // 没有组队
                        ...
                        if (next) {
                            ...
                            cm.askYesNo("你需要有一个 " + minPlayers + " - " + maxPlayers + " 人的队伍. 请您组好队员后再试.");
                        }
                        cm.dispose();
                    } //判断组队
                } else if (selection == 1) {
                    ...
                    sel = 4;
                    cm.askYesNo("学习[飞翔]技能必须付出一定的金币哟!大约需要:#r2000000#k,那么你想现在就学习么?");
                }
            } else if (status == 2) {
                if (sel == 4) {
