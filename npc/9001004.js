...
function action(mode, type, selection) {
    if (mode == -1 || mode == 0) {
        ...
        status++;
        if (status == 0) {
            cm.askMenu("Man... It is cold!!!~ How can I help you?\r\n#L0#Leave the event game.#l\r\n#L1#Buy the weapon (Wooden Club 1 meso)#l");
        } else if (status == 1) {
            if (selection == 0) {
                cm.askYesNo("If you leave now, you can't participate in this event for the next 24 hours. Are you sure you want to leave?");
            } else if (selection == 1) {
