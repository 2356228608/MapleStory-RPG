...
function action(mode, type, selection) {
    ...
    if (status <= i++) {
        ...
        cm.sendNextNoESC("00这不是#h0#吗？外游怎么样啊？不惜违抗命令出去，应该很快乐吧？你的家人都还好吧？替我跟她们问声好啊！哈哈哈哈！", 2159308);
        ...
        cm.inGameDirectionEvent_Effect("Effect/Direction6.img/effect/tuto/balloonMsg1/14", 2000, 0, -120);
        ...
        cm.npc_ChangeController(2159309, 180, 50, 0);
        ...
        cm.inGameDirectionEvent_Effect("Effect/Direction6.img/effect/tuto/balloonMsg1/15", 2000, 0, -120);
        ...
        cm.npc_ChangeController(2159309, 500, 50, 1);
        cm.npc_SetSpecialAction(2159309, "summon");
