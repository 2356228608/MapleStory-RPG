...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        //zyms += "                 #L3##r领取礼包#l \r\n";
        //cm.askMenu("亲爱的#b#h0##k您好，您有什么需要我帮忙的吗？\r\n\r\n#L0##b查看本NPC详细规则#k#l\r\n#L1##b领取奖励#k#l\r\n#L2##r兑换特别奖励#k#l");
        cm.askMenu(zyms);
    } else if (status == 1) {
        if (selection == 0) {
