...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        cm.askMenu("Would you like to become a #rWarrior?#k\r\n#b#L0#Yes#l\r\n#L1#No#l#k");
    } else if (status == 4) {
        if (selection == 0) {
            cm.askMenu("In order to make the job advancement, you must visit #rDances with Balrog#k at the #rWarrior's Sanctuary#k in #bPerion#k.Would you like to be trasported there now?-The transportation service cannot be used once you make the job advancement-\r\n\r\n#b#L0#Yes#l\r\n#L1#No#l#k");
        } else if (selection == 1) {
