    ...
    if (status == 0) {
        ...
        if (selection == 0) {
            ...
            if (facetype.length == 0)
                ...
                cm.setAvatar("随便看", facetype, faceCard);
        } else if (selection == 1) {
            types = 1;
            cm.askYesNo("使用皇家整容院优惠?唬?可以随意更改脸型。但是请别担心，我的手术已经达到了一树的境界。你真的要使用#b#t0" + faceCard + "##k，变换脸型吗？");
        }
    } else if (status == 3) {
        if (types == 0) {
            status = 0;
