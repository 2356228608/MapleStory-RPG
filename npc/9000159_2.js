...
function action(mode, type, selection) {
    ...
    if (status == 0) {//如果你有#b#t05152053##k 使用皇家整容院优惠券
        cm.askMenu("欢迎参加活动,接下来的#b2分钟#k你可以随意抽取#b皇家发型#k。免费的哟,千万别错过了!!\r\n#b#L0#立即抽取皇家发型(免费)#l");
    } else if (status == 1) {
        cm.askYesNo("整容后无法还原,你现在确定要更换脸型吗？");
    } else if (status == 2) {
        ...
        //if (cm.setRandomCharStyle(4001246, hair_Colo_new) == 1) {
        if (cm.setRandomCharStyle(4001246, facetype) == 1) {
