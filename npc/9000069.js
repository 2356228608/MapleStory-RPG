...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        firstSel = selection;
        cm.askYesNo("Oh, hey there. You seems to be more interested than I do. I can always upgrade your scrolls with a little fee and some materials. Are you sure you want to do that? #bThere is a 10% chance that the scroll might be destroyed in the process of the creation.#k")
    } else if (status == 2) {
