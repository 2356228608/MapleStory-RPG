        ...
        if (status == 0) {
            ...
            if (selection == 0) {
                if (cm.getParty() == null) { // 没有组队
                    ...
                    if (cm.getEventCount("鬼节1") < 1) {
                        if (cm.checkPartyEventCount("鬼节1")) {
                            ...
                            if (next) {
                                ...
                                if (em == null) {
                                    ...
                                    if (prop.equals("0") || prop == null) {
                                        ...
                                        cm.sendOk("[日常]鬼节魔法院任务里面已经有人了，请稍等！");
                                    }
                                }
                                cm.dispose();
                            } else {
