...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        cm.askMenu("Hello there~  I am Irene from Singapore Airport.  I was transferred to Victoria Tree Platform to celerbrate new opening of our service!  How can I help you?\r\n#b#L0# I would like to buy a plane ticket to Singapore#l#k\r\n#b#L1# Let me go in to the Singapore CBD.#l#k\r\n#b#L2# Let me go in to the Malaysia Trend Zone Metropolis#l#k");
    } else if (status == 1) {
        menu = selection;
        if (menu == 0) {
            cm.askYesNo("The ticket will cost you 300,000 mesos. Will you purchase the ticket?");
        } else if (menu == 1) {
            cm.askYesNo("Would you like to go now? You will lose your ticket once you go in~ Thank you for choosing Wizet Airline.");
        }
    } else if (status == 2) {
        if (menu == 0) {
            ...
            if (em == null) {
                ...
                cm.askYesNo("It looks like there's plenty of room for this ride. Please have your ticket ready so I can let you in, The ride will be long, but you'll get to your destination just fine. What do you think? Do you want to get on this ride?");
