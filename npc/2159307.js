...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        cm.sendNextSNoESC("...Tell me, Mastema, Who do you serve? Is it me, or the Black Mage?");
    } else if (status == 4) {
        cm.sendNextNoESC("W-wha?");
    } else if (status == 5) {
        cm.sendNextSNoESC("Answer me!");
    } else if (status == 6) {
        cm.sendNextNoESC("Well, I'm loyal to the Black Mage, of course. But we pledged our lives for each other. I go where you go.");
    } else if (status == 7) {
        cm.sendNextSNoESC("I have a favor to ask of you then... Give this letter to the #rHeroes#k.");
    } else if (status == 8) {
        ...
        cm.sendNextSNoESC("I am already finished as a Commander.");
    } else if (status == 10) {
        cm.sendNextNoESC("What? Are you betraying the Black Mage? Why are you doing this?");
    } else if (status == 11) {
        cm.sendNextSNoESC("There's no time to explain. Please do as I say. If not...");
    } else if (status == 12) {
        cm.sendNextNoESC("No, I'll do it. I'm just worried. What about your family? Wont' they be in dang-");
    } else if (status == 13) {
        cm.sendNextSNoESC("Not another word about my family!");
    } else if (status == 14) {
        ...
        cm.sendNextSNoESC("Thank you. Sorry for asking such a task of you.");
    } else if (status == 18) {
        ...
        cm.sendNextSNoESC("...Your loyalty means so much to me. Thank you.");
    } else if (status == 20) {
        cm.warp(927000080, 0);
        cm.dispose();
    }
