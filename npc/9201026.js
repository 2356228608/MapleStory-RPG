...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        cm.askYesNo("Have you ever been to the wedding village? It is an amazing place where the love is overloading. Loving couple can get married there, How romantic it is? If you want to be there, I'll show you the way.");
    } else if (status == 2) {
