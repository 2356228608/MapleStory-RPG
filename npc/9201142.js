    ...
    switch (status) {
        ...
        case 2:
            if (selected == 0) {
                ...
                selected2 = selection;
                cm.askYesNo("Do you want to trade your #b" + tokenExchange[selection][1] + " #t4000524#s#k with my #t" + tokenExchange[selection][0] + "#? \r\n\r\n#i" + tokenExchange[selection][0] + ":#  #t" + tokenExchange[selection][0] + "#");
            }
            break;
        case 3:
            if (selected == 0) {
                ...
                cm.askMenu(foodExchange[selected2][4]);
            } else if (selected == 1) {
