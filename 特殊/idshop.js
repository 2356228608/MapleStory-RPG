...
function startChat(selection) {
    if (chat == 0)
        cm.askMenu("Ello there, I'm the ID Shop.\r\nWhat would you like me to do for you?\r\n#L0#Have an Item by it's ID#l\r\n#L1#Look up for an Item's ID"/* + "\r\n#L2#Max my skills#l"*/ + "\r\n#L3#Give me NX!#l");
    else if (chat == 1) {
        switch (selection) {
            case 0:
                cm.askNumber("Enter Item's ID:", 0, 1002000, 6000000);
                select = 0;
                break;
            case 1:
                cm.askText("Enter Item's Name:");
                select = 1;
                break;
            case 2:
                ...
                break;
            case 3:
                cm.askNumber("Amount of NX:", 1, 1, 49999);
                select = 3;
                break;
        }
    } else if (chat == 2) {
        switch (select) {
            case 0:
                ...
                cm.askNumber("Enter the amount you want for the item:", 1, 1, 100);
                break;
            case 1:
