...
function setup(eim, leaderid) {
    ...
    var eim = em.newInstance("Boss_时间神殿_阿卡伊勒_简单");
...
function monsterValue(eim, mobId) {
	...
	eim.getPlayers().forEach(function (player) {
		player.updateAchievement(767, 0, "mob_kill", 1, 10);
		player.updateAchievement(768, 0, "mob_kill", 1, 100);
		player.updateAchievement(769, 0, "mob_kill", 1, 1000);
		player.updateAchievement(770, 0, "mob_kill", 1, 1000);
	});
    return 1;
}
