...
//自定义复活次数
var reviveCount = 5;
var mapIds = [211070104, 211070105, 211070112];
...
function setup(eim, leaderid) {
	...
	var eim = em.newInstance("Boss_狮子王城_班雷昂_困难");
...
function monsterValue(eim, mobId) {
	eim.getPlayers().forEach(function (player) {
		player.updateAchievement(751, 0, "mob_kill", 1, 10);
		player.updateAchievement(752, 0, "mob_kill", 1, 100);
		player.updateAchievement(753, 0, "mob_kill", 1, 1000);
		player.updateAchievement(754, 0, "mob_kill", 1, 1000);
	});
	return 1;
}
