...
function setup(level, leaderid) {
	var eim = em.newInstance("Boss_堕落世界树_黛米安_简单");
	...
	modified.setOHp(50000000000); //2:80000000000 3:150000000000 4:250000000000
	...
	mob = em.getMonster(mobid);
	modified = em.newMonsterStats();
	modified.setOHp(75000000000); //2:120000000000  3:200000000000  4:350000000000
	modified.setOMp(mob.getMobMaxMp() * 30);
	modified.setOExp(EXP);
