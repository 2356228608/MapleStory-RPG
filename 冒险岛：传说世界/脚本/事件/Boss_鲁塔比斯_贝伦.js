...
var mapIds = [105200400, 105200410];
...
function monsterValue(eim, mobId) {
	...
	eim.getPlayers().forEach(function (player) {
		...
		player.updateAchievement(731, 0, "mob_kill", 1, 10);
		player.updateAchievement(732, 0, "mob_kill", 1, 100);
		player.updateAchievement(733, 0, "mob_kill", 1, 1000);
		player.updateAchievement(734, 0, "mob_kill", 1, 1000);
	});
	return 1;
}
