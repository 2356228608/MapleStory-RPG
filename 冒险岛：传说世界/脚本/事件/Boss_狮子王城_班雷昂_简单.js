...
function setup(eim, leaderid) {
	...
	var eim = em.newInstance("Boss_狮子王城_班雷昂_简单");
...
function monsterValue(eim, mobId) {
	eim.getPlayers().forEach(function (player) {
		player.updateAchievement(743, 0, "mob_kill", 1, 10);
		player.updateAchievement(744, 0, "mob_kill", 1, 100);
		player.updateAchievement(745, 0, "mob_kill", 1, 1000);
		player.updateAchievement(746, 0, "mob_kill", 1, 1000);
	});
	return 1;
}
