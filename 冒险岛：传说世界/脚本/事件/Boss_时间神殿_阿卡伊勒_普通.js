...
function setup(eim, leaderid) {
    ...
    var eim = em.newInstance("Boss_时间神殿_阿卡伊勒_普通");
...
function monsterValue(eim, mobId) {
	...
	eim.getPlayers().forEach(function (player) {
		player.updateAchievement(771, 0, "mob_kill", 1, 10);
		player.updateAchievement(771, 0, "mob_kill", 1, 100);
		player.updateAchievement(773, 0, "mob_kill", 1, 1000);
		player.updateAchievement(774, 0, "mob_kill", 1, 1000);
		//  组队通关
		if (teamMembers == 1) {
			player.finishAchievement(775);
		}
	});
    return 1;
}
