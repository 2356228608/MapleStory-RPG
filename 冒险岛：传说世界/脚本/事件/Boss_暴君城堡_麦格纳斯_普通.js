...
function setup(eim, leaderid) {
    ...
    var eim = em.newInstance("Boss_暴君城堡_麦格纳斯_普通");
...
function monsterValue(eim, mobId) {
	...
	eim.getPlayers().forEach(function (player) {
		player.updateAchievement(673, 0, "mob_kill", 1, 10);
		player.updateAchievement(674, 0, "mob_kill", 1, 100);
		player.updateAchievement(675, 0, "mob_kill", 1, 1000);
		player.updateAchievement(676, 0, "mob_kill", 1, 1000);
	});
    return 1;
}
