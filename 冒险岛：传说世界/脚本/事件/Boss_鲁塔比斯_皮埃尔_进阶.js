...
var mapIds = [105200600, 105200610];
...
function monsterValue(eim, mobId) {
	...
	eim.getPlayers().forEach(function (player) {
		...
		player.updateAchievement(700, 0, "mob_kill", 1, 10);
		player.updateAchievement(701, 0, "mob_kill", 1, 100);
		player.updateAchievement(702, 0, "mob_kill", 1, 1000);
		player.updateAchievement(703, 0, "mob_kill", 1, 1000);
	});
	return 1;
}
