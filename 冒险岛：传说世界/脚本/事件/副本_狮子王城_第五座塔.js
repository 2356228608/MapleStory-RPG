 ...
 * by Jessefjxm
 */
var mapIds = [211061100];
var mapHall = 211061000;
var emName = "副本_狮子王城_第五座塔";
...
function setup(eim, leaderid) {
	...
	for (var i = 0; i < 1; i++) {
		var mob = em.getMonster(8210013);
		eim.registerMonster(mob);
		map.spawnMonsterOnGroundBelow(mob, new java.awt.Point(randomNum(700, 900), -215));
	}
	return eim;
}
