...
var open = true;
//配置文件名称
var PQname = ["Boss_堕落世界树_黛米安_简单", "Boss_堕落世界树_黛米安_普通", "Boss_堕落世界树_黛米安_困难", "Boss_堕落世界树_黛米安_地狱"];
//记录次数名称
var PQLog = ["戴米安[简单]", "戴米安[普通]", "戴米安[困难]", "戴米安[地狱]"];
//开始的地图
...
function action(mode, type, selection) {
	...
	if (cm.getMapId() == startmap) {
		if (status == 0) {
			...
			rwpz += "#n#k#e地图状态：#n" + (prop == null || prop.equals("0") ? "#e#g空闲#n#k" : "#e#r挑战中#n#k") + "";
			...
			if (channel[selection] == 0) {
				rwpz += "此地图不受频道限制.所有频道均可进入#k#n#k\r\n\r\n";
			} else {
				rwpz += "需要在：#r#e" + channel[selection] + "#n频道进入首领：#k#n#k\r\n\r\n";
			}
				...
				if (next) {
					...
					if (em == null || open == false) {
						...
						if (prop == null || prop.equals("0")) {
							...
							cm.worldSpouseMessage(0x15, "『首领挑战』 : " + cm.getChar().getName() + " 的敢死队队伍，气势汹汹的挑战 " + PQLog[chs] + " 去了。");
						} else {
