...
function action(mode, type, selection) {
	...
	if (status <= i++) {
		...
		ms.inGameDirectionEvent_Monologue("#fn黑体##fs32#B - 07 F\r\n\r\n#fs22#在黑魔法师的影响下，变得狂暴的猴子们正在攻击人类。\r\n\r\n啊，那边有人受到了猴子的攻击，看那边！", 30000);
	} else if (status === i++) {
		...
		ms.dispose();
		// TODO
		ms.getMap().startMapEffect("请你守护好那名被狂暴的猴子伤害的探险家。", 5120085);
		ms.warp(992007000, 1);
	} else {
		ms.dispose();
	}
